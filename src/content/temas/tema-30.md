...
# PARTE I — SEGURIDAD SOCIAL DEL PERSONAL AL SERVICIO DE LA ADMINISTRACIÓN LOCAL

## 1. ENCUADRAMIENTO DEL PERSONAL LOCAL EN EL SISTEMA DE SEGURIDAD SOCIAL

### 1.1 El Sistema de Seguridad Social español

El Sistema de Seguridad Social español tiene por objeto proteger a los ciudadanos frente a determinadas contingencias (enfermedad, accidente, desempleo, vejez, muerte...) que les impiden obtener ingresos suficientes para atender sus necesidades. Su norma básica es el **Texto Refundido de la Ley General de la Seguridad Social (TRLGSS)**, aprobado por RDL 8/2015.

### 1.2 Encuadramiento del personal local

El personal al servicio de las Entidades Locales queda encuadrado en el Sistema de Seguridad Social de la siguiente forma:
...
- **Cotizar** mensualmente tanto por la parte del trabajador (cuota obrera, que descuentan de la nómina) como por la parte de la empresa (cuota patronal).
- **Dar de baja** al trabajador cuando cese en el servicio.
...
### 3.1 Concepto y titulares

La **asistencia sanitaria** consiste en la prestación de los servicios médicos y farmacéuticos necesarios para conservar o restablecer la salud del trabajador, así como su aptitud para el trabajo.

Tienen derecho a la asistencia sanitaria:
- Los trabajadores afiliados y en alta en el Régimen General (o en situación asimilada al alta).
- Los pensionistas.
- Los familiares o asimilados a cargo del trabajador o pensionista.

### 3.2 Modalidades de asistencia sanitaria

La asistencia sanitaria comprende:
- Atención primaria (medicina de familia, pediatría).
- Atención especializada (consultas, pruebas diagnósticas, hospitalización, cirugía).
- Prestaciones farmacéuticas (con los copagos que correspondan según el nivel de renta).
- Atención de urgencias.
- Rehabilitación y fisioterapia cuando sea prescrita.
- Prestaciones ortoprotésicas y de transporte sanitario urgente.

### 3.3 Gestión de la asistencia sanitaria

La asistencia sanitaria es gestionada principalmente por el **Sistema Nacional de Salud** a través de las Comunidades Autónomas. En Castilla y León, el organismo competente es el **SACYL (Gerencia Regional de Salud de Castilla y León)**.
...
Durante la situación de IT, el trabajador tiene derecho a un **subsidio económico** (la «paga de la baja»), cuya cuantía varía según la contingencia:
...
- El control de la IT corresponde fundamentalmente al **INSS** y a los **Servicios Públicos de Salud**.
- Las **Mutuas Colaboradoras de la Seguridad Social** gestionan la IT derivada de contingencias profesionales.
- El **INSS** tiene competencia para emitir altas médicas a partir del día 365 de baja.
- La Corporación Local, como empleadora, puede solicitar reconocimiento médico del trabajador durante la IT y, en caso de discrepancia, solicitar al INSS la revisión del alta o la baja.

---

## 5. PRESTACIÓN POR NACIMIENTO Y CUIDADO DE MENOR (MATERNIDAD/PATERNIDAD)

### 5.1 Régimen vigente

Desde la reforma operada por el RDL 6/2019, la prestación por **maternidad** y **paternidad** se han equiparado en duración y condiciones, unificándose en la denominada **prestación por nacimiento y cuidado de menor** (arts. 177 y ss. TRLGSS).
...
### 6.2 Grados de incapacidad permanente
...
- La **IPT** es compatible con el ejercicio de otra profesión diferente a la habitual.
- La **IPA** y la **Gran invalidez** son incompatibles con cualquier trabajo retribuido, salvo que el INSS declare que la situación puede mejorar y autorice el trabajo.

---

# PARTE II — EL PRESUPUESTO DE LAS ENTIDADES LOCALES

## 7. EL PRESUPUESTO LOCAL: CONCEPTO Y MARCO NORMATIVO
...
La regulación del presupuesto local se contiene principalmente en:
- **TRLRHL** (RDL 2/2004): arts. 162 a 228.
- **Real Decreto 500/1990**, de 20 de abril: Reglamento de desarrollo en materia presupuestaria.
- Normas de la **IGAE** (Intervención General de la Administración del Estado) sobre contabilidad pública local, en particular la **Instrucción de Contabilidad para la Administración Local (ICAL)**.
...
## 8. ESTRUCTURA DEL PRESUPUESTO LOCAL

El presupuesto local se divide en dos grandes estados:

### 8.1 Estado de ingresos (previsiones)

Recoge los **recursos** que se prevé obtener durante el ejercicio. Se clasifica:

#### Por naturaleza económica (clasificación económica):
...
Recoge las **autorizaciones máximas de gasto** para el ejercicio. Se clasifica por tres criterios:

#### Clasificación orgánica:
Identifica **quién** gasta: la unidad administrativa responsable del crédito (Presidencia, Área de Hacienda, Área de Obras, etc.).

#### Clasificación por programas (funcional):
Identifica **para qué** se gasta: agrupa los créditos por las políticas de gasto o programas:
| Área de gasto | Contenido |
|---|---|
| 0 | Deuda pública |
| 1 | Servicios públicos básicos (seguridad, vivienda, bienestar comunitario) |
| 2 | Actuaciones de protección y promoción social |
| 3 | Producción de bienes públicos de carácter preferente (sanidad, educación, cultura) |
| 4 | Actuaciones de carácter económico |
| 9 | Actuaciones de carácter general (administración general, finanzas) |
...
## 9. ELABORACIÓN Y APROBACIÓN DEL PRESUPUESTO

### 9.1 Fases de elaboración
...
## 10. GESTIÓN ECONÓMICA LOCAL: ORDENACIÓN DE GASTOS Y PAGOS

### 10.1 El ciclo presupuestario del gasto

La gestión del gasto en las Entidades Locales sigue un **procedimiento de ejecución** secuencial con fases claramente diferenciadas. Cada fase genera un **documento contable** específico:

### 10.2 Fases del procedimiento de gasto y documentos contables
...
El **pago material** es la salida efectiva de fondos de la Tesorería hacia el acreedor. No genera un documento contable propio en el modelo simplificado, pero sí queda registrado en la contabilidad de la Tesorería.

### 10.3 Cuadro resumen del ciclo del gasto
...
### 10.4 Órganos competentes en la gestión económica local
...
## 11. LA CUENTA GENERAL DE LA ENTIDAD LOCAL
...
1. Formación de la Cuenta General por la **Intervención**, con los datos de la contabilidad.
2. Dictamen de la **Comisión Especial de Cuentas** del Pleno.
3. **Exposición pública** durante 15 días para que los interesados puedan formular reparos u observaciones.
4. Nuevo dictamen de la Comisión Especial de Cuentas sobre los reparos formulados.
5. **Aprobación por el Pleno**.
6. **Remisión al Tribunal de Cuentas** (u órgano de control externo de la Comunidad Autónoma) para su fiscalización externa.
...
<ul>
  <li>PARTE I: SEGURIDAD SOCIAL
    <ul>
      <li></li>
      <li>ENCUADRAMIENTO
        <ul>
          <li>Todo el personal local (funcionario y laboral) → RÉGIMEN GENERAL
            <ul>
              <li>(MUNPAL suprimida e integrada en el RG desde 1993) → Corporación Local = empresario cotizante (inscripción + afiliación + cotización)</li>
            </ul></li>
        </ul></li>
      <li>ACCIÓN PROTECTORA (art. 42 TRLGSS)
        <ul>
          <li>Asistencia sanitaria / IT / Nacimiento y cuidado de menor /
            <ul>
              <li>Riesgo embarazo / IP / Jubilación / Muerte y supervivencia / Desempleo / Prestaciones familiares</li>
            </ul></li>
        </ul></li>
      <li>INCAPACIDAD TEMPORAL (IT)
        <ul>
          <li>Contingencias: enf. común / acc. no laboral / acc. trabajo / enf. profesional</li>
          <li>Subsidio: días 1-3 sin subsidio / días 4-20: 60% BR / día 21+: 75% BR
            <ul>
              <li>→ Contingencias profesionales: 75% desde el día siguiente a la baja → Funcionarios: complemento corporativo hasta el 100%</li>
            </ul></li>
          <li>Duración: máx. 365 días + prórr. 180 días = 545 días máx.</li>
        </ul></li>
      <li>NACIMIENTO Y CUIDADO DE MENOR (antes maternidad/paternidad)
        <ul>
          <li>16 semanas para cada progenitor (6 obligatorias e ininterrumpidas)</li>
          <li>Cuantía: 100% de la base reguladora</li>
          <li>Requisito: 180 días cotizados en últimos 7 años (o 360 en toda la vida)</li>
        </ul></li>
      <li>INCAPACIDAD PERMANENTE
        <ul>
          <li>IPP: &lt; 33% capacidad → indemnización a tanto alzado (24 mensualidades BR)</li>
          <li>IPT: inhabilita para profesión habitual → pensión 55% BR (75% si &gt; 55 años: IPT cualificada)</li>
          <li>IPA: inhabilita para toda profesión → pensión 100% BR</li>
          <li>Gran invalidez: necesita ayuda de 3ª persona → 100% BR + complemento asistencial</li>
        </ul></li>
    </ul></li>
  <li>PARTE II: PRESUPUESTO LOCAL
    <ul>
      <li>CONCEPTO: expresión cifrada de obligaciones e ingresos previstos para el ejercicio
        <ul>
          <li>→ Carácter anual (año natural) / Principio de equilibrio presupuestario</li>
        </ul></li>
      <li>ESTRUCTURA
        <ul>
          <li>INGRESOS (Cap. 1-9): corrientes (1-5) / capital (6-7) / financieros (8-9)</li>
          <li>GASTOS (Cap. 1-9): corrientes (1-4) / capital (6-7) / financieros (8-9)
            <ul>
              <li>→ Triple clasificación del gasto: orgánica (quién) / funcional (para qué) / económica (en qué)</li>
            </ul></li>
        </ul></li>
      <li>APROBACIÓN
        <ul>
          <li>Elaboración → Informe Intervención → Aprobación inicial Pleno →
            <ul>
              <li>Exposición pública 15 días → Aprobación definitiva → Publicación BOP → Si no se aprueba antes del 1/1: PRÓRROGA automática del anterior</li>
            </ul></li>
        </ul></li>
      <li>CICLO DEL GASTO Y DOCUMENTOS CONTABLES
        <ul>
          <li>A  → Autorización (crédito retenido)</li>
          <li>D  → Disposición/Compromiso (crédito comprometido)</li>
          <li>O  → Reconocimiento de obligación (crédito obligado)</li>
          <li>P  → Ordenación del pago (orden a Tesorería)</li>
          <li>Pago material (salida efectiva de fondos) → Documentos combinados frecuentes: AD / ADO / ADOP</li>
        </ul></li>
      <li>ÓRGANOS COMPETENTES
        <ul>
          <li>Pleno: aprobar Presupuesto + Cuenta General + tributos + endeudamiento mayor</li>
          <li>Presidente: ordenar pagos + autorizar gastos (dentro de sus límites)</li>
          <li>Intervención: fiscalización previa + contabilidad + control interno</li>
          <li>Tesorería: recaudación + custodia de fondos + pago de obligaciones</li>
        </ul></li>
      <li>CUENTA GENERAL
        <ul>
          <li>Intervención → Comisión Especial de Cuentas → Exposición pública 15 días
            <ul>
              <li>→ Aprobación por Pleno → Remisión al Tribunal de Cuentas</li>
            </ul></li>
        </ul></li>
    </ul></li>
</ul>
...
*Fin del Tema 30 — Administrativo C1 | Preparación OEP 2026*
