...
> - [Real Decreto Legislativo 8/2015, de 30 de octubre, Texto Refundido de la Ley General de la Seguridad Social (TRLGSS)](https://www.boe.es/buscar/act.php?id=BOE-A-2015-11724)
> - [Ley 29/1975, de 27 de junio, de la Mutualidad General de Funcionarios Civiles del Estado (MUFACE)](https://www.boe.es/buscar/act.php?id=BOE-A-1975-13498)

---

## 1. EL SISTEMA RETRIBUTIVO DE LOS EMPLEADOS PÚBLICOS
...
En las Administraciones Públicas conviven dos regímenes retributivos distintos:
...
El **sueldo** es la retribución básica por excelencia, asignada a cada funcionario en función de su **grupo o subgrupo de clasificación profesional** (art. 76 TREBEP). Los grupos y sus equivalencias son:
...
Las **retribuciones complementarias** son específicas de cada puesto de trabajo y de cada funcionario. El TREBEP establece las siguientes modalidades, que las Leyes de cada Administración desarrollan:
...
#### 2.3.4 Las gratificaciones por servicios extraordinarios

Las **gratificaciones por servicios extraordinarios** retribuyen los servicios prestados fuera de la jornada normal de trabajo. Tienen carácter excepcional y no pueden ser fijas en su cuantía ni periódicas en su devengo. En muchas Administraciones se han sustituido en la práctica por el sistema de compensación con tiempo libre (descansos compensatorios), especialmente cuando los servicios extraordinarios superan determinados límites.

#### 2.3.5 La carrera profesional horizontal

El TREBEP prevé la posibilidad de que las leyes de función pública de cada Administración establezcan sistemas de **carrera profesional horizontal** que permitan al funcionario progresar retributivamente sin necesidad de ascender a un puesto de trabajo de nivel superior. Estos sistemas se articulan mediante la asignación de **grados, categorías o escalones** que se van reconociendo en función de la trayectoria profesional, los méritos y la evaluación del desempeño, y van asociados a un complemento retributivo específico.

### 2.4 Las pagas extraordinarias en situaciones especiales

En determinadas situaciones (incapacidad temporal, permisos no retribuidos, suspensión de funciones), las retribuciones del funcionario se ven reducidas o suprimidas. En el caso de la **incapacidad temporal**, el funcionario percibe inicialmente el 100% de sus retribuciones (sueldo, trienios y complementos), pero a partir del cuarto día de baja la situación varía según la normativa de cada Administración y el tipo de incapacidad (enfermedad común, accidente de trabajo, etc.).

---

## 3. RETRIBUCIONES DEL PERSONAL LABORAL
...
## 4. LA NÓMINA: ESTRUCTURA Y CONFECCIÓN
...
- Un documento **laboral**: acredita el salario percibido por el trabajador y sirve de base para calcular las cotizaciones a la Seguridad Social.
- Un documento **tributario**: sirve de base para practicar las retenciones a cuenta del IRPF.

### 4.2 Estructura de la nómina: devengos

Los **devengos** son todos los conceptos que generan derecho retributivo para el empleado. Se dividen en percepciones salariales y no salariales:

**Percepciones salariales:**
- Sueldo base (o salario base, para personal laboral).
- Trienios (o antigüedad, para personal laboral).
- Complemento de destino.
- Complemento específico.
- Complemento de productividad.
- Gratificaciones por servicios extraordinarios.
- Prorrata de pagas extraordinarias (si se abonan en doce mensualidades) o paga extraordinaria completa en junio y diciembre.
- Otros complementos: complementos de carrera horizontal, complementos personales transitorios, etc.

**Percepciones no salariales (indemnizaciones y suplidos):**
- Indemnizaciones por razón del servicio: dietas, gastos de desplazamiento, alojamiento, indemnizaciones por traslado forzoso.
- Plus de transporte, si procede.
- Prestaciones de la Seguridad Social abonadas por delegación (incapacidad temporal a partir de un determinado período).

### 4.3 Estructura de la nómina: deducciones

Las **deducciones** son los importes que se descuentan del total de devengos:

#### 4.3.1 Cuotas a la Seguridad Social (cotización a cargo del trabajador)
...
Además, el **empleador (la Administración)** cotiza a la Seguridad Social por cada empleado a tipos superiores (cotización patronal): contingencias comunes (23,60%), desempleo (5,50% para contrato indefinido), FOGASA (0,20%), formación profesional (0,60%), más las cotizaciones por accidentes de trabajo y enfermedades profesionales según la tarifa aplicable a la actividad.
...
Al final del año, la Administración entrega a cada empleado el **certificado de retenciones** (certificado de rentas) que detalla las retribuciones abonadas y las retenciones practicadas durante el ejercicio, documento imprescindible para que el empleado pueda realizar su declaración del IRPF.
...
El **líquido a percibir** (también llamado «importe neto» o «líquido») es la cantidad que finalmente se abona al empleado:

```
TOTAL DEVENGOS
   - Cotización a la Seguridad Social (trabajador)
   - Retención IRPF
   - Otras deducciones
= LÍQUIDO A PERCIBIR
```
...
## 5. ALTAS Y BAJAS EN NÓMINA

### 5.1 Altas

Se produce un **alta en nómina** cuando un empleado público se incorpora al servicio activo y comienza a generar derecho a percibir retribuciones:
- Toma de posesión de un funcionario de nuevo ingreso.
- Reingreso al servicio activo desde una situación administrativa distinta (excedencia, servicios especiales, etc.).
- Incorporación de personal laboral de nuevo ingreso o tras una situación de suspensión del contrato.

El alta implica la comunicación a la Seguridad Social (a través del sistema RED) del alta del trabajador en el régimen correspondiente, en el plazo máximo de 60 días naturales antes del inicio de la prestación de servicios (alta previa) o al inicio de la prestación de servicios. En la práctica, el alta debe comunicarse antes del inicio del trabajo.

### 5.2 Bajas

Se produce una **baja en nómina** cuando el empleado deja de percibir retribuciones por cesar su vinculación con la Administración o pasar a una situación que no genera devengo de retribuciones:
- Jubilación, fallecimiento, renuncia, separación del servicio o pérdida de la condición de funcionario.
- Excedencia voluntaria o por cuidado de hijos (situaciones en que no se perciben retribuciones).
- Suspensión de funciones.

La baja debe comunicarse a la Seguridad Social dentro de los tres días naturales siguientes al cese.

### 5.3 La incapacidad temporal (IT)
...
## 6. LA SEGURIDAD SOCIAL DEL PERSONAL LABORAL
...
El RGSS cubre las siguientes **contingencias** (situaciones protegidas):
...
Las **bases de cotización** de cada trabajador se calculan mensualmente y sirven para determinar tanto las cuotas a ingresar como la cuantía de las futuras prestaciones. La base de cotización incluye todas las percepciones retributivas del trabajador, excluidas las que expresamente están exentas (dietas, gastos de locomoción con ciertos límites, etc.).

Existen **bases mínimas y máximas** de cotización que se fijan anualmente en la Ley de Presupuestos Generales del Estado. Ningún trabajador puede cotizar por debajo de la base mínima (aunque gane menos, se cotiza por la mínima del grupo de cotización) ni por encima de la base máxima (aunque gane más, la cotización no aumenta sobre ese límite).

### 6.4 La gestión de la Seguridad Social: el Sistema RED

Las Administraciones, como cualquier empresa, gestionan su relación con la Seguridad Social a través del **Sistema RED** (Remisión Electrónica de Documentos), que es la plataforma telemática de la TGSS para el intercambio de información sobre afiliación, cotización y recaudación. A través del Sistema RED se tramitan las altas y bajas, se presentan los partes de cotización mensuales (TC2) y se ingresan las cuotas.

---

## 7. EL RÉGIMEN DE MUFACE Y LAS CLASES PASIVAS

### 7.1 La MUFACE

La **MUFACE** (Mutualidad General de Funcionarios Civiles del Estado) es el sistema de protección social específico de los funcionarios civiles del Estado (los que pertenecen a Cuerpos y Escalas de la Administración General del Estado). Los funcionarios del Estado no están integrados en el RGSS; en su lugar, están afiliados a la MUFACE.
...
### 7.2 Las Clases Pasivas del Estado
...
## 8. RETRIBUCIONES EN SITUACIONES ADMINISTRATIVAS ESPECIALES

El TREBEP regula el régimen retributivo en las distintas **situaciones administrativas** en que puede encontrarse el funcionario:
...
<ul>
  <li>SISTEMA RETRIBUTIVO PÚBLICO
    <ul>
      <li>Funcionarios: TREBEP / Ley de Presupuestos / normativa de cada AAPP</li>
      <li>Personal laboral: ET + convenio colectivo</li>
    </ul></li>
  <li>RETRIBUCIONES DE FUNCIONARIOS
    <ul>
      <li>BÁSICAS (iguales para todos los del mismo subgrupo)
        <ul>
          <li>Sueldo: según Grupo/Subgrupo (A1/A2/C1/C2/Agrupaciones)
            <ul>
              <li>→ C1: Bachillerato — el subgrupo de las oposiciones que preparamos</li>
            </ul></li>
          <li>Trienios: cuantía fija por cada 3 años / importe varía por grupo</li>
          <li>Pagas extraordinarias: 2 al año (junio y diciembre) = 1 mensualidad (sueldo + trienios)</li>
        </ul></li>
      <li>COMPLEMENTARIAS (específicas del puesto y del funcionario)
        <ul>
          <li>Complemento de destino: retribuye el NIVEL del puesto (del 1 al 30)
            <ul>
              <li>→ Igual para todos los funcionarios del mismo nivel</li>
            </ul></li>
          <li>Complemento específico: condiciones particulares del puesto
            <ul>
              <li>(dificultad técnica / dedicación / incompatibilidad / responsabilidad / peligrosidad) → Variable por puesto / fijado en la RPT</li>
            </ul></li>
          <li>Complemento de productividad: rendimiento individual / variable / no consolida</li>
          <li>Gratificaciones servicios extraordinarios: horas fuera de jornada / excepcionales</li>
          <li>Carrera profesional horizontal: grados/escalones sin ascender de puesto</li>
        </ul></li>
    </ul></li>
  <li>RETRIBUCIONES PERSONAL LABORAL
    <ul>
      <li>Salario base + complementos salariales + pagas extras
        <ul>
          <li>→ Fijadas en convenio colectivo (AGE: IV Convenio Único / CyL: convenio propio)</li>
        </ul></li>
    </ul></li>
  <li>LA NÓMINA
    <ul>
      <li>Documento contable (O+P) + laboral + tributario</li>
      <li>DEVENGOS (percepciones salariales + no salariales):
        <ul>
          <li>Sueldo / Trienios / C. Destino / C. Específico / C. Productividad / Gratificaciones / Prorrata pagas extras / Dietas e indemnizaciones</li>
        </ul></li>
      <li>DEDUCCIONES:
        <ul>
          <li>Cotización SS trabajador: contingencias comunes (4,70%) + desempleo (1,55%) +
            <ul>
              <li>FP (0,10%) + MEI (0,13%)</li>
            </ul></li>
          <li>Retención IRPF: calculada sobre retribuciones anuales y circunstancias personales
            <ul>
              <li>→ Empleado comunica datos con modelo 145 → Administración ingresa retenciones con modelo 111 → Certificado de retenciones al cierre del año</li>
            </ul></li>
          <li>Otras: cuotas sindicales / anticipos / embargos / reintegros</li>
        </ul></li>
      <li>LÍQUIDO = Total devengos − deducciones</li>
    </ul></li>
  <li>ALTAS Y BAJAS EN NÓMINA
    <ul>
      <li>Alta: toma de posesión / reingreso → comunicar a SS antes del inicio</li>
      <li>Baja: cese / jubilación / excedencia sin retribuciones → comunicar en 3 días</li>
      <li>IT: subsidio (60% días 4-20 / 75% día 21+) — AAPP suele complementar al 100%</li>
    </ul></li>
  <li>SEGURIDAD SOCIAL DEL PERSONAL LABORAL
    <ul>
      <li>Régimen General SS: mismo que empresa privada</li>
      <li>Acción protectora: IT / IP / jubilación / muerte y supervivencia /
        <ul>
          <li>maternidad-paternidad / desempleo / riesgo embarazo</li>
        </ul></li>
      <li>Bases de cotización: mínimas y máximas fijadas en Ley de Presupuestos</li>
      <li>Gestión: Sistema RED (telemático) — altas, bajas, partes de cotización (TC2)</li>
    </ul></li>
  <li>MUFACE Y CLASES PASIVAS
    <ul>
      <li>MUFACE: funcionarios civiles AGE
        <ul>
          <li>→ Asistencia sanitaria: elección libre entre red pública o aseguradora privada → Prestaciones IT / IP / fallecimiento → Funcionarios locales y autonómicos: RGSS (regla general) → CyL: funcionarios Junta → RGSS</li>
        </ul></li>
      <li>Clases Pasivas: pensiones de funcionarios AGE ingresados ANTES del 1/1/2011
        <ul>
          <li>→ Jubilación / viudedad / orfandad / inutilidad → Gestionadas por INSS desde 2011</li>
        </ul></li>
      <li>Desde 1/1/2011: nuevos funcionarios AGE → RGSS (convergencia con sistema general)
        <ul>
          <li>→ Los ingresados antes de 2011 mantienen Clases Pasivas</li>
        </ul></li>
    </ul></li>
</ul>
</div>
...
*Fin del Tema 45 — Administrativo C1 | Preparación OEP 2026 — JCyL / Diputación de Burgos*
