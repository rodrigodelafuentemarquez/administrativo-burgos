...
### 1.3 El sector público en sentido amplio

La LRJSP distingue entre:
...
### 2.1 Los principios constitucionales (art. 103.1 CE)

El art. 103.1 CE establece los principios a los que debe sujetarse la organización y actuación de la Administración Pública:

> *"La Administración Pública sirve con objetividad los intereses generales y actúa de acuerdo con los principios de eficacia, jerarquía, descentralización, desconcentración y coordinación, con sometimiento pleno a la ley y al Derecho."*

A estos principios constitucionales se añaden los recogidos en el **art. 3 LRJSP**, que los amplía y concreta.

### 2.2 Principios de organización en detalle

#### 2.2.1 Jerarquía

La organización administrativa se estructura de forma piramidal: los órganos superiores dirigen, supervisan e instruyen a los órganos inferiores. Las órdenes e instrucciones del superior son vinculantes para el inferior.

La jerarquía opera **dentro de una misma Administración** y de una misma línea orgánica. No opera entre Administraciones distintas (no hay jerarquía entre el Estado y las CC.AA.).

Instrumentos de la jerarquía:
- Las **instrucciones y circulares** (art. 6 LRJSP): directrices internas del superior al inferior. No son normas jurídicas en sentido estricto y no crean derechos para los ciudadanos.
- El **control de legalidad** por el superior sobre los actos del inferior.
- La **avocación** (art. 10 LRJSP): el órgano superior recaba para sí el conocimiento de un asunto cuya resolución corresponde a un órgano inferior.
...
Supone la transferencia de competencias desde un **órgano superior a un órgano inferior** dentro de la **misma Administración y persona jurídica**. No implica creación de un ente nuevo.
...
La Administración debe **conseguir los resultados previstos** con los medios disponibles, en el menor tiempo posible y con el menor coste. No basta con actuar conforme a la ley; es necesario que la actuación sea efectiva en la consecución del interés general.

La eficacia está vinculada a los principios de **celeridad** (agilidad en la tramitación), **economía** (uso eficiente de recursos) y **servicio efectivo a los ciudadanos** (art. 3.1 LRJSP).

#### 2.2.6 Objetividad e imparcialidad
...
### 2.3 Principios adicionales del art. 3 LRJSP

El art. 3.1 LRJSP añade a los constitucionales los siguientes principios de actuación:
...
La actividad administrativa se ejerce a través de **órganos administrativos**. El art. 5 LRJSP establece que los órganos:

- Se crean, modifican y suprimen mediante **norma** (ley o reglamento orgánico, según el caso).
- Tienen atribuidas **competencias** propias.
- Actúan en nombre de la Administración a la que pertenecen.

Junto a los órganos existen las **unidades administrativas** (divisiones funcionales sin competencia propia atribuida por norma, que apoyan la gestión de los órganos).
...
- **Avocación** (art. 10 LRJSP): el superior recaba para sí el conocimiento de un asunto del inferior, por razones de oportunidad o conveniencia, en casos singulares.
- **Encomienda de gestión** (art. 11 LRJSP): se encarga la realización de actividades materiales, técnicas o de servicios a otro órgano o entidad, sin transferir la competencia ni la responsabilidad.
- **Delegación de firma** (art. 12 LRJSP): el titular de la competencia delega solo la firma de resoluciones, sin transferir la competencia.
- **Suplencia** (art. 13 LRJSP): sustitución temporal del titular por ausencia, enfermedad o vacante.
...
La Administración no está sometida solo a la ley formal sino al ordenamiento en su conjunto: Constitución, leyes, reglamentos, principios generales del Derecho, Derecho de la UE. A este conjunto se le denomina **bloque de legalidad** o **bloque normativo**.
...
- Condenar a la Administración a indemnizar los daños causados (responsabilidad patrimonial, art. 106.2 CE).
- Obligar a la Administración a actuar cuando tiene el deber de hacerlo (condena a hacer).

### 3.5 La autotutela administrativa y sus límites

La Administración goza de **autotutela**: puede declarar sus propios derechos (autotutela declarativa) y ejecutarlos sin necesidad de acudir a los tribunales (autotutela ejecutiva). Esta prerrogativa —excepcional frente al régimen general del Derecho Privado— está sujeta a límites:

- Solo puede ejercerse cuando la ley lo permite.
- Está sometida a los principios de proporcionalidad y necesidad.
- El ciudadano puede impugnarla ante los tribunales contencioso-administrativos.

### 3.6 La interdicción de la arbitrariedad (art. 9.3 CE)

El art. 9.3 CE garantiza la **interdicción de la arbitrariedad de los poderes públicos**. La Administración puede tener facultades discrecionales (márgenes de apreciación que la ley le confiere), pero jamás puede actuar de forma arbitraria: toda decisión debe estar motivada, ser razonable y respetar los principios de igualdad y proporcionalidad.

La **discrecionalidad** (actuación dentro de los márgenes que la ley permite) es legítima; la **arbitrariedad** (actuación sin sujeción a criterio alguno o de forma caprichosa) es antijurídica y contraria a la CE.

Los tribunales controlan la arbitrariedad mediante:
- El control de los **elementos reglados** del acto discrecional (competencia, procedimiento, fin…).
- La aplicación de los **principios generales del Derecho** (proporcionalidad, igualdad, buena fe…).
- El control de la **desviación de poder**: uso de una potestad para un fin distinto del previsto en la norma.
...
<ul>
  <li>ADMINISTRACIONES PÚBLICAS
    <ul>
      <li>Pluralidad: AGE + CC.AA. + Administración Local + sector institucional</li>
      <li>Personalidad jurídica única por Administración</li>
      <li>Los órganos NO tienen personalidad jurídica propia</li>
    </ul></li>
  <li>PRINCIPIOS DE ORGANIZACIÓN (art. 103.1 CE + art. 3 LRJSP)
    <ul>
      <li>Jerarquía → dentro de la misma Administración (instrucciones, avocación)</li>
      <li>Descentralización → entre personas jurídicas distintas (Estado → CC.AA./EELL)</li>
      <li>Desconcentración → dentro de la misma persona jurídica (órgano superior → inferior)</li>
      <li>Coordinación → armonización entre órganos o Administraciones</li>
      <li>Eficacia → consecución de resultados</li>
      <li>Objetividad e imparcialidad → abstención y recusación</li>
      <li>Otros (art. 3 LRJSP): buena fe, confianza legítima, proporcionalidad,
        <ul>
          <li>lealtad institucional, transparencia, servicio efectivo…</li>
        </ul></li>
    </ul></li>
  <li>COMPETENCIA
    <ul>
      <li>Irrenunciable e improrrogable</li>
      <li>Técnicas de alteración:
        <ul>
          <li>Delegación (art. 9) → transfiere ejercicio, no titularidad</li>
          <li>Avocación (art. 10) → superior recaba asunto del inferior</li>
          <li>Encomienda de gestión (art. 11) → actividad material, sin competencia</li>
          <li>Delegación de firma (art. 12) → solo la firma</li>
          <li>Suplencia (art. 13) → sustitución temporal del titular</li>
        </ul></li>
    </ul></li>
  <li>SOMETIMIENTO A LA LEY Y AL DERECHO
    <ul>
      <li>Principio de legalidad (art. 103.1 CE): vinculación positiva
        <ul>
          <li>→ La Administración solo hace lo que la ley permite</li>
        </ul></li>
      <li>Bloque de legalidad: CE + leyes + reglamentos + PGD + Derecho UE</li>
      <li>Control judicial (art. 106 CE): tribunales contencioso-administrativos</li>
      <li>Autotutela: declarativa + ejecutiva (con límites)</li>
      <li>Interdicción de la arbitrariedad (art. 9.3 CE)
        <ul>
          <li>→ Discrecionalidad ≠ Arbitrariedad → Control: elementos reglados + PGD + desviación de poder</li>
        </ul></li>
    </ul></li>
</ul>
</div>
...
*Fin del Tema 13 — Administrativo C1 | Preparación OEP 2026*
