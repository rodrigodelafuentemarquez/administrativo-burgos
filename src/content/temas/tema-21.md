...
### 1.2 Ámbito de aplicación subjetivo (art. 2 LTBG)
...
### 2.2 Información objeto de publicidad activa (arts. 6-8 LTBG)

La LTBG distingue tres grandes bloques de información que deben publicarse activamente:

#### A) Información institucional, organizativa y de planificación (art. 6 LTBG)
- Las funciones que desarrollan, la normativa aplicable y su estructura organizativa.
- Los planes y programas anuales y plurianuales, con sus objetivos, actividades, medios y tiempo previsto para su consecución, así como el grado de cumplimiento y resultados.

#### B) Información de relevancia jurídica (art. 7 LTBG)
- Las directrices, instrucciones, acuerdos, circulares o respuestas a consultas que tengan efectos jurídicos externos.
- Los anteproyectos de ley o de reglamentos cuya iniciativa les corresponda.
...
#### C) Información económica, presupuestaria y estadística (art. 8 LTBG)
- Los contratos, con indicación del objeto, duración, importe de licitación y adjudicación, procedimiento y número de licitadores.
- Los convenios suscritos, con mención de las partes firmantes, su objeto y las obligaciones económicas.
...
- Las retribuciones de los máximos responsables y altos cargos.
- Las resoluciones de autorización o reconocimiento de compatibilidad de altos cargos.
- Las declaraciones de actividades y bienes e intereses de los representantes locales y altos cargos.
- La información estadística necesaria para valorar el grado de cumplimiento y calidad de los servicios públicos.

### 2.3 Límites a la publicidad activa

La publicidad activa no alcanza a la información cuya difusión pudiera perjudicar:
- La **seguridad nacional**.
- La **defensa**.
- Las **relaciones exteriores**.
- La **seguridad pública o la prevención, investigación y sanción de infracciones** penales, administrativas o disciplinarias.
- La **igualdad de las partes en los procesos judiciales** o la tutela judicial efectiva.
...
El derecho de acceso puede ser **limitado** cuando el acceso a la información suponga un perjuicio para:

| Límite | Ejemplo |
|---|---|
| Seguridad nacional | Información clasificada |
| Defensa | Planes militares |
| Relaciones exteriores | Negociaciones diplomáticas |
| Seguridad pública | Investigaciones policiales en curso |
| Prevención y sanción de infracciones | Expedientes sancionadores en tramitación |
| Igualdad de partes en procesos judiciales | Expedientes judiciales |
| Funciones de inspección y control | Inspecciones tributarias en curso |
| Intereses económicos y comerciales | Secretos empresariales de terceros |
| Política económica y monetaria | Deliberaciones del Banco de España |
| Secreto profesional | Comunicaciones abogado-cliente |
| Propiedad intelectual e industrial | Patentes, derechos de autor |
...
El **Consejo de Transparencia y Buen Gobierno** es un organismo público independiente, adscrito al Ministerio de Hacienda, que vela por el cumplimiento de las obligaciones de publicidad activa y tutela el ejercicio del derecho de acceso a la información.

Sus funciones principales son:
- **Conocer las reclamaciones** que los ciudadanos interpongan contra las resoluciones expresas o presuntas en materia de acceso a la información.
- Promover la **transparencia** de la actividad pública.
- Emitir **recomendaciones** y **criterios interpretativos**.

**La reclamación ante el Consejo de Transparencia** es un recurso administrativo **potestativo** y previo (o alternativo) al recurso contencioso-administrativo:
- Plazo de interposición: **1 mes** desde la notificación de la resolución denegatoria o desde que se produce el silencio negativo.
- Plazo de resolución: **3 meses** (silencio negativo).

> 💡 En las CC.AA. con organismo equivalente al Consejo de Transparencia (como el Comisionado de Transparencia de Castilla y León), la reclamación se presenta ante ese organismo autonómico.
...
El Título II de la LTBG (arts. 25-40) regula las **obligaciones de buen gobierno** aplicables a los miembros del Gobierno, Secretarios de Estado, altos cargos de la AGE, de los organismos del sector público estatal y, con carácter supletorio, a los cargos equivalentes de CC.AA. y EELL.

Establece **principios de actuación** (de conducta y buen gobierno) y un **régimen sancionador** para los casos de incumplimiento, que puede dar lugar a sanciones económicas, la obligación de reintegrar cantidades percibidas indebidamente y la prohibición de acceso a cargos públicos.
...
El tratamiento de datos personales debe respetar los siguientes principios:
...
El tratamiento de datos personales solo es lícito si se basa en alguna de las siguientes bases:
...
- Satisfacción de **intereses legítimos** del responsable (excepto cuando prevalezcan los derechos del interesado).

> 💡 Para las **Administraciones Públicas**, la base más frecuente es el cumplimiento de una obligación legal o el ejercicio de poderes públicos, no el consentimiento.
...
- **Afiliación sindical.**
- **Datos genéticos y biométricos** (cuando permitan identificar de forma unívoca a una persona).
...
El responsable debe aplicar medidas técnicas y organizativas apropiadas desde el momento del diseño del tratamiento para garantizar los principios de protección de datos.

#### Registro de actividades de tratamiento (art. 30 RGPD)
Los responsables y encargados deben llevar un **registro** de todas las actividades de tratamiento bajo su responsabilidad.
...
- Investigar reclamaciones de los ciudadanos.
- Imponer **sanciones** a los responsables o encargados del tratamiento que incumplan la normativa.
- Elaborar **guías y recomendaciones** sobre protección de datos.
- Autorizar tratamientos en casos especiales.

**Régimen sancionador (arts. 83 RGPD y 72-74 LOPDGDD):**
...
<ul>
  <li>TRANSPARENCIA (Ley 19/2013 — LTBG)
    <ul>
      <li></li>
      <li>PUBLICIDAD ACTIVA (de oficio, sin solicitud)
        <ul>
          <li>Información institucional y organizativa (art. 6)</li>
          <li>Información de relevancia jurídica (art. 7)</li>
          <li>Información económica y presupuestaria (art. 8)</li>
        </ul></li>
      <li>DERECHO DE ACCESO (a petición del ciudadano)
        <ul>
          <li>Cualquier persona, sin motivar, sin coste</li>
          <li>Plazo resolución: 1 mes (ampliable a 2 meses)</li>
          <li>Silencio: NEGATIVO</li>
          <li>Límites: seguridad, defensa, datos personales…</li>
          <li>Reclamación ante Consejo de Transparencia (potestativa, 1 mes)
            <ul>
              <li>→ plazo resolución 3 meses (silencio negativo)</li>
            </ul></li>
        </ul></li>
      <li>CONSEJO DE TRANSPARENCIA Y BUEN GOBIERNO
        <ul>
          <li>Organismo independiente; tutela el acceso; resuelve reclamaciones</li>
        </ul></li>
    </ul></li>
  <li>PROTECCIÓN DE DATOS (RGPD + LOPDGDD)
    <ul>
      <li>PRINCIPIOS: licitud, limitación de finalidad, minimización,
        <ul>
          <li>exactitud, limitación temporal, integridad, accountability</li>
        </ul></li>
      <li>BASES JURÍDICAS: consentimiento, contrato, obligación legal,
        <ul>
          <li>interés vital, interés público, interés legítimo</li>
        </ul></li>
      <li>DATOS ESPECIALMENTE PROTEGIDOS: raza, política, religión,
        <ul>
          <li>sindicato, salud, genéticos, biométricos, vida/orientación sexual</li>
        </ul></li>
      <li>DERECHOS (ARSOPOL): Acceso, Rectificación, Supresión,
        <ul>
          <li>Oposición, Portabilidad, Limitación → plazo respuesta: 1 mes (ampliable a 2)</li>
        </ul></li>
      <li>OBLIGACIONES DEL RESPONSABLE:
        <ul>
          <li>Privacidad desde el diseño</li>
          <li>Registro de actividades de tratamiento</li>
          <li>DPD obligatorio en AAPP (independiente, inamovible)</li>
          <li>Notificación violación seguridad: 72 horas a la AEPD</li>
          <li>EIPD para tratamientos de alto riesgo</li>
        </ul></li>
      <li>AEPD: autoridad de control independiente
        <ul>
          <li>Sanciones: hasta 20M€ o 4% facturación (muy graves)</li>
          <li>AAPP: no sanción económica → apercibimiento + disciplina</li>
        </ul></li>
    </ul></li>
</ul>
</div>
...
*Fin del Tema 21 — Administrativo C1 | Preparación OEP 2026*
