...
## 1. FUNDAMENTO Y OBJETO DE LA LEY

### 1.1 La función pública autonómica en el sistema constitucional
...
- Los **funcionarios interinos** de la Administración de la Comunidad de Castilla y León.
- El **personal eventual** de la Administración de la Comunidad de Castilla y León.

El **personal laboral** al servicio de la Junta de Castilla y León se rige por el Estatuto de los Trabajadores y el convenio colectivo aplicable, aunque determinadas normas de la LFPCYL le son de aplicación supletoria o por remisión expresa.
...
Una vez adquirida la condición de funcionario de carrera, esta solo puede perderse por las causas tasadas en la ley: renuncia, pérdida de la nacionalidad, jubilación, sanción disciplinaria de separación del servicio, pena de inhabilitación absoluta o especial para cargo público impuesta mediante sentencia judicial firme, y destitución mediante expediente disciplinario.
...
### 2.4 Personal directivo profesional

El TREBEP prevé la figura del **personal directivo**, que en Castilla y León se rige por lo establecido en la propia LFPCYL y en las normas de desarrollo. El personal directivo desempeña funciones directivas profesionales en la Administración de la Comunidad de Castilla y León, y su nombramiento atiende a principios de mérito y capacidad y a criterios de idoneidad, con evaluación periódica de su desempeño.

---

## 3. CUERPOS Y ESCALAS EN LA JUNTA DE CASTILLA Y LEÓN

### 3.1 Clasificación del personal funcionario

Los funcionarios de carrera de la Administración de la Comunidad de Castilla y León se agrupan en **Cuerpos y Escalas** en función de la titulación exigida para el acceso y de las funciones que desempeñan. La LFPCYL establece la siguiente clasificación, en correspondencia con los grupos del TREBEP:
...
## 4. ACCESO AL EMPLEO PÚBLICO EN CASTILLA Y LEÓN
...
### 4.3 Requisitos generales para el acceso

Los candidatos a los procesos selectivos de la Junta de Castilla y León deben reunir, en la fecha de terminación del plazo de presentación de solicitudes, los siguientes requisitos generales:
...
La LFPCYL y el TREBEP prevén los siguientes **sistemas selectivos**:

#### 4.4.1 Oposición

La **oposición** consiste en la superación de una o varias pruebas de aptitud para determinar la capacidad y aptitud de los aspirantes. Es el sistema que mejor garantiza los principios de mérito, capacidad e igualdad, y es el sistema ordinario para el acceso al empleo público. Las pruebas pueden ser teóricas (test, desarrollo escrito, exposición oral), prácticas o una combinación de ambas.

#### 4.4.2 Concurso-oposición

El **concurso-oposición** combina una fase de oposición (pruebas de aptitud) con una fase de concurso (valoración de méritos: experiencia profesional, formación, titulaciones adicionales, etc.). En el concurso-oposición, la fase de oposición tiene carácter previo a la fase de concurso y es eliminatoria: solo acceden al concurso quienes superan la oposición. Los méritos solo se valoran una vez superadas las pruebas selectivas.
...
Los procesos selectivos son organizados y evaluados por **órganos de selección** (tribunales o comisiones de selección) que actúan con independencia funcional del órgano convocante. Sus miembros son nombrados por la Consejería competente en materia de función pública y deben ser funcionarios de carrera del grupo o subgrupo igual o superior al de las plazas convocadas.

El órgano de selección propone al órgano convocante los candidatos que han superado el proceso selectivo, con su puntuación final. Solo pueden proponerse tantos candidatos como plazas convocadas: no puede aprobarse un candidato si no hay plaza para él.
...
Los funcionarios de carrera de la Junta de Castilla y León pueden cubrir puestos de trabajo mediante los siguientes procedimientos:
...
La **adscripción provisional** permite cubrir puestos de trabajo con carácter temporal mientras se tramita el procedimiento ordinario de provisión o en situaciones de urgencia. El funcionario adscrito provisionalmente tiene obligación de participar en los concursos que se convoquen para cubrir el puesto.

#### 5.2.4 Comisión de servicios

La **comisión de servicios** es el desempeño temporal de un puesto de trabajo distinto del propio, en la misma o diferente unidad administrativa, por razones del servicio o a petición del interesado. Puede ser voluntaria (a petición del funcionario) o forzosa (por necesidades del servicio). La comisión de servicios tiene carácter temporal y el funcionario conserva su puesto de origen.

---

## 6. LA CARRERA PROFESIONAL

### 6.1 La carrera vertical

La **carrera vertical** consiste en el ascenso a puestos de trabajo de nivel superior dentro del Cuerpo o Escala, mediante la participación en concursos de méritos. A través de la carrera vertical, el funcionario va ocupando puestos de mayor responsabilidad y nivel, lo que conlleva un incremento de las retribuciones complementarias (complemento de destino y complemento específico).
...
### 6.3 La carrera horizontal y la evaluación del desempeño

La LFPCYL, siguiendo la previsión del TREBEP, contempla la implantación de sistemas de **carrera profesional horizontal** que permitan al funcionario progresar retributivamente sin necesidad de cambiar de puesto, reconociendo el desarrollo de competencias, la trayectoria profesional, los méritos y los resultados obtenidos. Este sistema se articula mediante la **evaluación del desempeño**: valoración periódica del rendimiento, conducta profesional y consecución de objetivos del funcionario.

La evaluación del desempeño tiene importantes efectos: puede condicionar el percibo del complemento de productividad, la progresión en la carrera horizontal e incluso, si el resultado es gravemente insatisfactorio de forma reiterada y previo expediente contradictorio, puede implicar la remoción del puesto de trabajo.

### 6.4 La promoción interna

La **promoción interna** permite a los funcionarios de carrera ascender de un subgrupo de clasificación al inmediatamente superior. Para ello deben superar el proceso selectivo convocado a tal efecto y reunir los requisitos de titulación del subgrupo al que aspiran. Las plazas de promoción interna se reservan específicamente para funcionarios ya en activo, que además pueden recibir una valoración adicional de sus méritos y experiencia previa.

---

## 7. SITUACIONES ADMINISTRATIVAS

La LFPCYL regula las distintas **situaciones administrativas** en que puede encontrarse un funcionario, siguiendo el esquema del TREBEP con las particularidades autonómicas:

### 7.1 Servicio activo

El **servicio activo** es la situación ordinaria del funcionario que ocupa un puesto de trabajo en la Administración y ejerce efectivamente las funciones que tiene asignadas. En situación de servicio activo, el funcionario percibe todas sus retribuciones y derechos.

### 7.2 Servicios especiales

El funcionario pasa a la situación de **servicios especiales** cuando es nombrado para determinados cargos de especial relevancia pública que son incompatibles con el desempeño ordinario del puesto: miembro del Gobierno o de los órganos de gobierno de otras Administraciones, magistrado del Tribunal Constitucional, Defensor del Pueblo, parlamentario nacional o autonómico, cargo electivo en las Corporaciones Locales, alto cargo de organismos internacionales, entre otros.

En servicios especiales, el funcionario tiene derecho a reserva del puesto de trabajo, a que se le compute el tiempo en esta situación a efectos de trienios, carrera y derechos pasivos, y percibe las retribuciones del cargo o puesto que motivó el pase a esta situación.
...
**Excedencia por violencia de género:** la funcionaria víctima de violencia de género puede solicitar la excedencia con plenos efectos de servicio activo durante los seis primeros meses (prorrogables hasta dieciocho).

### 7.5 Suspensión de funciones

La **suspensión de funciones** puede ser provisional (durante la tramitación de un expediente disciplinario o un proceso penal) o firme (como sanción disciplinaria). El funcionario suspendido no puede ejercer sus funciones ni percibir retribuciones durante el período de suspensión. La suspensión firme implica la pérdida del puesto de trabajo.
...
La LFPCYL, siguiendo el TREBEP, reconoce a los funcionarios de la Junta de Castilla y León los siguientes derechos:
...
- A participar en la consecución de los objetivos de la unidad y a ser informado de las tareas a desarrollar.
- A la defensa jurídica y protección de la Administración en los procedimientos que se sigan ante cualquier orden jurisdiccional como consecuencia del ejercicio legítimo de sus funciones.
- A la formación continua y a la actualización permanente de sus conocimientos.
- Al respeto de su intimidad, a la orientación sexual, a la propia imagen y a la dignidad en el trabajo.
- A la no discriminación por razón de nacimiento, origen racial, sexo, orientación sexual, religión o convicciones, opinión, discapacidad, edad u otras circunstancias personales.
...
- Al ejercicio de la huelga, con el mantenimiento de los servicios esenciales.
- Al planteamiento de conflictos colectivos.
- Al derecho de reunión.

### 8.2 Deberes

Los funcionarios de la Junta de Castilla y León tienen, entre otros, los siguientes deberes:
...
- Actuar con arreglo a los principios de objetividad, integridad, neutralidad, responsabilidad, imparcialidad, confidencialidad, dedicación al servicio público, transparencia, ejemplaridad, austeridad, accesibilidad, eficacia, honradad, promoción del entorno cultural y medioambiental y respeto de la igualdad entre mujeres y hombres.
- Obedecer las instrucciones y órdenes profesionales de los superiores jerárquicos, salvo que constituyan una infracción manifiesta del ordenamiento jurídico.
...
- Cumplir con diligencia la jornada de trabajo.

---

## 9. RÉGIMEN DISCIPLINARIO

### 9.1 Principios del régimen disciplinario
...
- Toda actuación que suponga discriminación por razón de origen racial, sexo, orientación sexual, religión, opinión, discapacidad, edad u otras circunstancias.
...
- El notorio incumplimiento de las funciones esenciales del puesto de trabajo.
- La violación de la imparcialidad usando las facultades del cargo para favorecer o perjudicar a partidos políticos, sindicatos u organizaciones.
- La desobediencia abierta a las órdenes de los superiores.
- Las conductas constitutivas de acoso sexual, acoso por razón de sexo o acoso laboral.
...
- La tolerancia de los superiores respecto de la comisión de faltas graves o muy graves de sus subordinados.
- La grave desconsideración con los ciudadanos, superiores o compañeros.
- El incumplimiento de las normas sobre incompatibilidades.
- La realización de actividades privadas incompatibles con el cargo.
- La emisión de informes manifiestamente ilegales o causantes de daño grave.
- El incumplimiento injustificado de la jornada de trabajo cuando acumule el equivalente a diez faltas de puntualidad en tres meses.

**Infracciones leves (ejemplos):**
- El incumplimiento injustificado del horario de trabajo hasta un máximo de diez faltas de puntualidad en tres meses.
- La negligencia en el cumplimiento de las funciones.
- La incorrección con el público, superiores, compañeros o subordinados.
- El descuido en la conservación de los locales, material o documentos de los servicios.
- El incumplimiento de los deberes y obligaciones del funcionario, siempre que no constituya falta muy grave o grave.

### 9.3 Sanciones

Las sanciones aplicables son las siguientes, en correspondencia con la gravedad de la infracción:
...
La imposición de cualquier sanción disciplinaria requiere la instrucción previa de un **expediente disciplinario** contradictorio, salvo en el caso de las faltas leves, que pueden sancionarse mediante procedimiento sumario. El expediente disciplinario garantiza el derecho de defensa del funcionario mediante la audiencia previa a los hechos imputados. La resolución del expediente disciplinario corresponde al Consejero competente (infracciones muy graves) o al órgano directivo superior del funcionario (graves y leves).

---

## 10. NEGOCIACIÓN COLECTIVA Y PARTICIPACIÓN

### 10.1 Las Mesas de Negociación

La LFPCYL y el TREBEP establecen que las condiciones de trabajo de los empleados públicos se determinan mediante **negociación colectiva** en el ámbito de las **Mesas de Negociación**, que son órganos de composición paritaria entre la Administración y las organizaciones sindicales más representativas.

En la Junta de Castilla y León existen:
- La **Mesa General de Negociación de los Empleados Públicos de la Administración de la Comunidad de Castilla y León**: negocia las condiciones comunes a todos los empleados públicos (funcionarios y laborales).
- Mesas sectoriales para colectivos específicos (docentes, sanitarios, etc.).

### 10.2 Materias objeto de negociación

Son objeto de negociación, entre otras, las siguientes materias:
- La aplicación del incremento de retribuciones.
- La determinación y aplicación de las retribuciones complementarias.
- Los planes de empleo y oferta de empleo público.
- Los criterios generales de los planes y fondos de formación.
- Los planes de previsión social complementaria.
- Los criterios generales para la elaboración de los concursos de provisión de puestos de trabajo.
- Los sistemas de carrera profesional horizontal y la evaluación del desempeño.
- Las medidas de conciliación de la vida personal, familiar y laboral.

### 10.3 El derecho de huelga en la Función Pública

El derecho de huelga del personal al servicio de las Administraciones Públicas está reconocido constitucionalmente (art. 28.2 CE), pero con la limitación del mantenimiento de los **servicios esenciales para la comunidad**: cuando se convoca una huelga en los servicios públicos, la Administración debe establecer los servicios mínimos necesarios para garantizar la prestación de los servicios esenciales a los ciudadanos. El incumplimiento de los servicios mínimos por parte de los huelguistas puede dar lugar a responsabilidad disciplinaria.
...
<ul>
  <li>FUNDAMENTO Y ÁMBITO
    <ul>
      <li>Art. 149.1.18 CE: Estado → bases (TREBEP) / CyL → desarrollo (Ley 7/2005)</li>
      <li>Aplica a: funcionarios carrera + interinos + eventual de la Junta CyL</li>
    </ul></li>
  <li>CLASES DE PERSONAL
    <ul>
      <li>Funcionario de carrera: vinculación permanente / adquiere condición con nombramiento + posesión
        <ul>
          <li>Pérdida: renuncia / pérdida nacionalidad / jubilación / separación / inhabilitación</li>
        </ul></li>
      <li>Funcionario interino: necesidad urgente / plaza vacante / sustitución / programa temporal /
        <ul>
          <li>exceso tareas (max. 6 meses en 12) / cese cuando desaparece la causa</li>
        </ul></li>
      <li>Personal eventual: confianza y asesoramiento / libre nombramiento y cese /
        <ul>
          <li>cesa automáticamente con el cargo político / no ejerce potestades administrativas</li>
        </ul></li>
      <li>Personal directivo: méritos + capacidad + idoneidad / evaluación periódica</li>
    </ul></li>
  <li>CUERPOS Y ESCALAS EN JUNTA CyL
    <ul>
      <li>A1: Cuerpo Superior / A2: Cuerpo de Gestión</li>
      <li>C1: Cuerpo Administrativo → las oposiciones que preparamos</li>
      <li>C2: Cuerpo Auxiliar / Agrupaciones profesionales</li>
      <li>Cuerpo Administrativo C1: funciones de gestión administrativa, tramitación de expedientes,
        <ul>
          <li>atención al ciudadano, registro, archivo, gestión económica básica</li>
        </ul></li>
    </ul></li>
  <li>ACCESO AL EMPLEO PÚBLICO
    <ul>
      <li>Principios: igualdad / mérito / capacidad / publicidad / transparencia / imparcialidad</li>
      <li>OEP: aprueba Consejo de Gobierno / BOCYL + BOE / convocatoria en 3 años max.</li>
      <li>Requisitos: nacionalidad / capacidad funcional / 16 años-jubilación / no separación /
        <ul>
          <li>titulación del subgrupo / pago derechos de examen</li>
        </ul></li>
      <li>Sistemas selectivos:
        <ul>
          <li>Oposición: solo pruebas → sistema ordinario / mejor garantía mérito y capacidad</li>
          <li>Concurso-oposición: oposición (eliminatoria) + valoración méritos → sistema mixto</li>
          <li>Concurso: solo méritos → excepcional / personal laboral / estabilización</li>
        </ul></li>
    </ul></li>
  <li>PROVISIÓN DE PUESTOS (RPT: instrumento de ordenación)
    <ul>
      <li>Concurso de méritos: sistema ORDINARIO / grado personal + experiencia + formación
        <ul>
          <li>→ genera reserva del puesto</li>
        </ul></li>
      <li>Libre designación: puestos de especial responsabilidad o confianza / cese libre</li>
      <li>Adscripción provisional: carácter temporal / obligación de concursar</li>
      <li>Comisión de servicios: temporal / voluntaria o forzosa / conserva puesto de origen</li>
    </ul></li>
  <li>CARRERA PROFESIONAL
    <ul>
      <li>Carrera vertical: ascenso a puestos superiores via concursos de méritos</li>
      <li>Grado personal: nivel de C. Destino consolidado / 2 años consecutivos o 3 con interrupción
        <ul>
          <li>→ derecho a percibir mínimo el C. Destino del grado aunque ocupe puesto inferior</li>
        </ul></li>
      <li>Carrera horizontal: progresión sin cambiar puesto / evaluación del desempeño</li>
      <li>Promoción interna: ascenso de subgrupo / proceso selectivo específico + titulación</li>
    </ul></li>
  <li>SITUACIONES ADMINISTRATIVAS
    <ul>
      <li>Servicio activo: situación ordinaria / todas las retribuciones</li>
      <li>Servicios especiales: cargo público incompatible / reserva puesto + cómputo trienios</li>
      <li>Servicio en otras AAPP: prestación en otra Administración</li>
      <li>Excedencia voluntaria (interés particular): min. 2 años / sin retribución / sin reserva</li>
      <li>Excedencia cuidado hijos: max. 3 años / 1er año = servicio activo + reserva puesto</li>
      <li>Excedencia por violencia de género: hasta 18 meses como servicio activo</li>
      <li>Suspensión de funciones: provisional (expediente/proceso penal) o firme (sanción)</li>
    </ul></li>
  <li>DERECHOS Y DEBERES
    <ul>
      <li>Derechos: inamovilidad / retribuciones / carrera / formación / no discriminación /
        <ul>
          <li>conciliación / sindicación / huelga / negociación colectiva</li>
        </ul></li>
      <li>Deberes: diligencia / objetividad / obediencia (salvo infracción manifiesta) /
        <ul>
          <li>secreto profesional / respeto a ciudadanos y compañeros / neutralidad política</li>
        </ul></li>
    </ul></li>
  <li>RÉGIMEN DISCIPLINARIO
    <ul>
      <li>Principios: legalidad / tipicidad / culpabilidad / proporcionalidad /
        <ul>
          <li>non bis in idem / presunción de inocencia</li>
        </ul></li>
      <li>Infracciones muy graves: separación / suspensión 3-6 años / traslado forzoso
        <ul>
          <li>Prescripción: 3 años / sanción: 3 años</li>
        </ul></li>
      <li>Infracciones graves: suspensión 1 día-3 años / traslado / demérito
        <ul>
          <li>Prescripción: 2 años / sanción: 2 años</li>
        </ul></li>
      <li>Infracciones leves: apercibimiento / deducción retribuciones
        <ul>
          <li>Prescripción: 6 meses / sanción: 1 año</li>
        </ul></li>
      <li>Procedimiento: expediente disciplinario contradictorio (salvo leves: sumario)</li>
    </ul></li>
  <li>NEGOCIACIÓN COLECTIVA
    <ul>
      <li>Mesa General de Negociación de Empleados Públicos CyL: paritaria AAPP-sindicatos</li>
      <li>Materias: retribuciones / OEP / formación / carrera / concursos / conciliación</li>
      <li>Huelga: derecho constitucional (art. 28.2 CE) / con mantenimiento de servicios mínimos
        <ul>
          <li>→ incumplimiento servicios mínimos = posible responsabilidad disciplinaria</li>
        </ul></li>
    </ul></li>
</ul>
</div>
...
*Fin del Tema 46 — Administrativo C1 | Preparación OEP 2026 — JCyL / Diputación de Burgos*
