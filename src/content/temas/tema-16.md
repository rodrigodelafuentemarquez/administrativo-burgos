...
### 2.1 Por sus efectos sobre los destinatarios
...
- Actos de la **AGE**, de las **CC.AA.**, de las **Entidades Locales**, del **sector público institucional**.
...
- Expresión de los **recursos** que procedan, el órgano ante el que interponerlos y el **plazo** para hacerlo.
...
**Notificación defectuosa:** si la notificación no contiene los requisitos exigidos (en especial los recursos procedentes y el plazo), no produce efectos. Sin embargo, si el interesado interpone el recurso procedente, la notificación surtirá efecto desde ese momento.

### 4.3 La publicación (art. 45 LPACAP)

Sustituye a la notificación cuando:
- El acto tiene por destinatarios a una pluralidad indeterminada de personas.
- Así lo establece la norma reguladora del procedimiento.
- Los interesados son desconocidos.
- Se intentó la notificación y no pudo practicarse.

### 4.4 Demora en la eficacia: condición y término

El acto puede estar sujeto a **condición suspensiva** (no produce efectos hasta que se cumple un evento futuro e incierto) o a **término inicial** (no produce efectos hasta una fecha determinada).

### 4.5 Suspensión de la eficacia

La ejecutividad del acto puede suspenderse:
- Automáticamente, en los casos previstos en la ley.
- A solicitud del interesado al interponer un recurso, si concurren determinadas circunstancias (art. 117 LPACAP): que la ejecución pudiera causar perjuicios de imposible o difícil reparación, o que el recurso se fundase en causa de nulidad de pleno derecho.
...
Son nulos de pleno derecho los actos administrativos que incurran en alguna de las siguientes causas **tasadas**:
...
- Es **imprescriptible**: puede declararse en cualquier momento.
- Produce efectos **ex tunc** (desde el origen del acto, con carácter retroactivo).
- Puede apreciarse de **oficio** por la Administración o a instancia de parte.
...
- Es **subsanable** mediante convalidación (art. 52 LPACAP).
- Está sujeta a **plazo**: los actos firmes solo pueden impugnarse a través de la revisión de oficio.
- Produce efectos **ex nunc** (desde que se declara, sin retroactividad, salvo que se decida lo contrario).

### 5.3 La convalidación (art. 52 LPACAP)

La Administración puede **convalidar** los actos anulables (no los nulos de pleno derecho) subsanando los vicios de que adolezcan. La convalidación produce efectos desde la fecha del acto convalidado, salvo que afecte a terceros de buena fe.

Ejemplos de convalidación:
- Si el vicio consiste en **incompetencia jerárquica** (no territorial ni material), el superior jerárquico puede convalidar el acto.
- Si el vicio consiste en la falta de alguna **autorización**, el órgano competente para otorgarla puede convalidar el acto ratificándola.
...
La **revisión de oficio** es el mecanismo por el que la propia Administración, sin necesidad de que el ciudadano interponga un recurso, declara la invalidez de sus propios actos. Es una manifestación de la **autotutela** y del principio de legalidad.

Se distingue de la revocación: la revisión de oficio opera sobre actos **inválidos** (contrarios al ordenamiento); la revocación opera sobre actos **válidos** pero inconvenientes o inoportunos.
...
2. Dictamen preceptivo y **favorable** del **Consejo de Estado** u órgano consultivo equivalente de la CC.AA.
...
### 6.4 Revocación de actos (art. 109 LPACAP)

Las Administraciones pueden **revocar** sus actos de gravamen o desfavorables, siempre que:
- No constituya dispensa o exención no permitida por el ordenamiento.
- No sea contraria al principio de igualdad, al interés público o al ordenamiento.

Los actos **favorables** no pueden revocarse por razones de oportunidad salvo en los casos previstos en la ley (por ejemplo, revocación de autorizaciones por incumplimiento de condiciones).

### 6.5 Rectificación de errores (art. 109.2 LPACAP)

Las Administraciones pueden rectificar en cualquier momento, de oficio o a instancia de los interesados, los **errores materiales, aritméticos o de hecho** que contengan sus actos, sin seguir el procedimiento de revisión. Los errores de Derecho requieren el procedimiento completo de revisión.
...
<ul>
  <li>CONCEPTO
    <ul>
      <li>Declaración unilateral de la Administración en ejercicio de potestad,
        <ul>
          <li>con efectos jurídicos</li>
        </ul></li>
    </ul></li>
  <li>CLASES
    <ul>
      <li>Por efectos: favorables / desfavorables</li>
      <li>Por destinatarios: singulares / generales</li>
      <li>Por margen de apreciación: reglados / discrecionales</li>
      <li>Por posición en el procedimiento: definitivos / de trámite</li>
    </ul></li>
  <li>REQUISITOS
    <ul>
      <li>Subjetivos: competencia + investidura regular del titular</li>
      <li>Objetivos: causa, objeto lícito/posible/determinado, fin (sin desviación de poder)</li>
      <li>Formales: procedimiento + forma escrita (regla general) + motivación (art. 35 LPACAP)</li>
    </ul></li>
  <li>EFICACIA
    <ul>
      <li>Ejecutividad inmediata (art. 38 LPACAP)</li>
      <li>Notificación en 10 días: texto íntegro + recursos + plazos
        <ul>
          <li>Electrónica (preferente para obligados): DEHú, 10 días para acceder</li>
          <li>En papel: 2 intentos, luego BOE</li>
        </ul></li>
      <li>Suspensión: de oficio o a solicitud del interesado al recurrir</li>
    </ul></li>
  <li>INVALIDEZ
    <ul>
      <li>NULIDAD DE PLENO DERECHO (art. 47 LPACAP)
        <ul>
          <li>Causas tasadas: lesión DDFF, incompetencia absoluta,
            <ul>
              <li>contenido imposible, infracción penal, ausencia total de procedimiento, actos que otorgan derechos sin requisitos, causas legales</li>
            </ul></li>
          <li>Absoluta, insubsanable, imprescriptible, efectos ex tunc</li>
          <li>Puede apreciarse de oficio</li>
        </ul></li>
      <li>ANULABILIDAD (art. 48 LPACAP)
        <ul>
          <li>Cualquier infracción del ordenamiento no constitutiva de nulidad</li>
          <li>Solo si produce indefensión o influye en la resolución</li>
          <li>Subsanable por convalidación</li>
          <li>Sujeta a plazo; efectos ex nunc</li>
        </ul></li>
    </ul></li>
  <li>REVISIÓN DE OFICIO
    <ul>
      <li>Actos NULOS → revisión directa, sin plazo, dictamen Consejo de Estado
        <ul>
          <li>(si el dictamen es contrario, no se puede continuar)</li>
        </ul></li>
      <li>Actos ANULABLES favorables → declaración de lesividad (4 años)
        <ul>
          <li>+ impugnación ante la jurisdicción contencioso-administrativa</li>
        </ul></li>
      <li>Revocación → actos de gravamen, por razones de oportunidad</li>
      <li>Rectificación de errores materiales → en cualquier momento, sin procedimiento</li>
    </ul></li>
</ul>
</div>
...
*Fin del Tema 16 — Administrativo C1 | Preparación OEP 2026*
