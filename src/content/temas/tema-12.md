...
> ⚠️ **Nota sobre el programa:** El Tema 12 del BOP Burgos reproduce en parte el contenido del Tema 11 (fuentes del Derecho y jerarquía normativa). La diferencia esencial es que el Tema 12 incorpora los **conceptos previos de Administración Pública y Derecho Administrativo** como punto de partida, desarrollando luego el sistema de fuentes con el mismo rigor. Se trata de un tema puente entre la teoría general del Estado y el Derecho Administrativo en sentido estricto.
...
El **art. 2 LRJSP** delimita qué entes tienen la consideración de Administración Pública a efectos de esa ley:

- La **Administración General del Estado (AGE)**.
- Las **Administraciones de las Comunidades Autónomas**.
- Las **Entidades que integran la Administración Local** (municipios, provincias, islas…).
- El **sector público institucional** de cada una de las anteriores (organismos autónomos, entidades públicas empresariales, agencias, etc.), cuando ejerzan potestades administrativas.
...
El **Derecho Administrativo** es la parte del Derecho Público interno que regula:

1. La **organización** de las Administraciones Públicas.
2. Las **relaciones** de las Administraciones entre sí y con los ciudadanos.
3. El **control** de la actividad administrativa por los tribunales.

Es un derecho **estatutario**: se aplica a la Administración por el hecho de serlo, con independencia del objeto concreto de su actuación.

### 2.2 Caracteres esenciales
...
Las **fuentes del Derecho** son los modos de producción y expresión de las normas jurídicas; es decir, los actos o hechos de los que el ordenamiento jurídico hace depender la creación, modificación o extinción de normas.

El **art. 1.1 del Código Civil** reconoce como fuentes del ordenamiento jurídico español: la **ley**, la **costumbre** y los **principios generales del Derecho**, en ese orden de aplicación supletoria. En el Derecho Administrativo, sin embargo, la ley (en sentido amplio) es con diferencia la fuente principal, siendo la costumbre prácticamente residual.
...
| Rango | Tipo de norma | Órgano productor |
|---|---|---|
| 1º | Constitución Española | Poder constituyente |
| 2º | Tratados internacionales y Derecho de la UE | Estado + organismos internacionales |
| 3º | Leyes Orgánicas | Cortes Generales (mayoría absoluta Congreso) |
| 4º | Leyes ordinarias | Cortes Generales (mayoría simple) |
| 5º | Normas con fuerza de ley (Decreto-ley y Decreto legislativo) | Gobierno |
| 6º | Reglamentos (Real Decreto, Orden Ministerial, Resolución…) | Gobierno y Administración |

Junto a la jerarquía rige el principio de **competencia**: cuando dos normas del mismo rango regulan materias distintas sin solaparse, prevalece la dictada por el órgano que tiene atribuida esa competencia.
...
La Constitución es directamente aplicable. No requiere leyes de desarrollo para vincular a los ciudadanos y a los poderes públicos. Esta eficacia directa es especialmente intensa en relación con los derechos fundamentales.

### 5.3 Control de constitucionalidad

Corresponde al **Tribunal Constitucional** depurar el ordenamiento de las normas con rango de ley que contradigan la CE (recurso de inconstitucionalidad, cuestión de inconstitucionalidad). Los tribunales ordinarios pueden inaplicar reglamentos inconstitucionales sin necesidad de elevar la cuestión al TC.
...
La **ley** es la norma jurídica aprobada por las **Cortes Generales** (o por las Asambleas legislativas de las CC.AA. en su ámbito) siguiendo el procedimiento constitucionalmente establecido. Es la norma primaria, subordinada solo a la CE.

### 6.2 Ley Orgánica (art. 81 CE)

Las leyes orgánicas regulan materias que la CE reserva expresamente a esta categoría:

- Desarrollo de los **derechos fundamentales y libertades públicas** (arts. 15-29 CE).
...
Regula las materias no reservadas a ley orgánica. Se aprueba por **mayoría simple**. En caso de discrepancia entre Congreso y Senado, la voluntad del Congreso prevalece.

---

## 7. DISPOSICIONES NORMATIVAS CON FUERZA DE LEY

Son normas dictadas por el **Gobierno** con el mismo rango que la ley, sin seguir el procedimiento legislativo parlamentario ordinario. La CE prevé dos tipos:
...
- Los derechos, deberes y libertades del Título I CE.
...
- El TC controla su adecuación a la CE.
...
El **Reglamento** es una norma jurídica de carácter general, aprobada por la **Administración Pública** en ejercicio de la potestad reglamentaria. Es la fuente más abundante del Derecho Administrativo.

Su fundamento constitucional está en el **art. 97 CE**: el Gobierno ejerce la potestad reglamentaria de acuerdo con la CE y las leyes.
...
1. **Consulta pública previa** a ciudadanos y organizaciones (salvo excepciones).
2. **Elaboración del texto** por el órgano competente.
3. **Audiencia e información pública** (plazo mínimo de 15 días hábiles para los interesados).
4. **Informes preceptivos** (jurídico, económico, impacto de género, etc.).
5. **Dictamen del Consejo de Estado** (obligatorio para reglamentos ejecutivos).
6. **Aprobación** por el órgano competente.
...
## 9. OTRAS FUENTES: COSTUMBRE, PRINCIPIOS GENERALES Y JURISPRUDENCIA

### 9.1 La costumbre

Tiene aplicación **muy residual** en Derecho Administrativo. Rige solo en defecto de ley aplicable y siempre que no sea contraria a la moral o al orden público. Su uso más frecuente se da en la organización interna de algunos entes locales y corporaciones.

### 9.2 Los principios generales del Derecho

Reglas jurídicas implícitas en el ordenamiento que sirven para colmar lagunas e informar la interpretación normativa. Muchos tienen reconocimiento constitucional expreso: legalidad, igualdad, proporcionalidad, buena fe, confianza legítima, seguridad jurídica… El **art. 3 LRJSP** los recoge como principios de actuación de las Administraciones Públicas.

### 9.3 La jurisprudencia

No es formalmente fuente del Derecho (art. 1.6 CC: "complementará el ordenamiento jurídico"). La doctrina reiterada del **Tribunal Supremo** orienta pero no vincula normativamente. Sí vinculan con efectos erga omnes las sentencias del **Tribunal Constitucional** que declaran la inconstitucionalidad de normas.

### 9.4 El Derecho de la Unión Europea

El Derecho de la UE —especialmente los reglamentos europeos (aplicables directamente) y las directivas (que requieren transposición)— se integra en el ordenamiento español y **desplaza** al Derecho interno contradictorio, incluso al de rango legal, por el principio de primacía del Derecho de la UE. Las Administraciones nacionales están obligadas a aplicarlo directamente.
...
<ul>
  <li>ADMINISTRACIÓN PÚBLICA
    <ul>
      <li>Sentido subjetivo: conjunto de entes y órganos</li>
      <li>Sentido objetivo: actividad de gestión del interés general</li>
      <li>Art. 103 CE: objetividad, eficacia, jerarquía, descentralización,
        <ul>
          <li>desconcentración, coordinación, sometimiento a la ley</li>
        </ul></li>
      <li>Potestades: reglamentaria, autotutela, expropiatoria, sancionadora…</li>
    </ul></li>
  <li>DERECHO ADMINISTRATIVO
    <ul>
      <li>Derecho Público, interno, estatutario, exorbitante, garantista</li>
      <li>Regula: organización + relaciones + control de la Administración</li>
    </ul></li>
  <li>FUENTES DEL DERECHO ADMINISTRATIVO
    <ul>
      <li>Escritas: CE, tratados, leyes, reglamentos, Derecho UE</li>
      <li>No escritas: costumbre (residual), principios generales</li>
    </ul></li>
  <li>JERARQUÍA (art. 9.3 CE)
    <ul>
      <li>1º Constitución (norma normarum)</li>
      <li>2º Tratados internacionales y Derecho UE</li>
      <li>3º Leyes Orgánicas (mayoría absoluta Congreso)</li>
      <li>4º Leyes ordinarias (mayoría simple)</li>
      <li>5º Normas con fuerza de ley
        <ul>
          <li>Decreto-ley: urgencia, control 30 días, límites materiales</li>
          <li>Decreto legislativo: delegación, texto articulado/refundido</li>
        </ul></li>
      <li>6º Reglamentos (Real Decreto &gt; Orden Ministerial &gt; Resolución)
        <ul>
          <li>Fundamento: art. 97 CE</li>
          <li>Límites: legalidad, reserva de ley, jerarquía, irretroactividad</li>
          <li>Nulidad de pleno derecho si contradicen norma superior</li>
        </ul></li>
    </ul></li>
  <li>OTRAS FUENTES
    <ul>
      <li>Costumbre (muy residual)</li>
      <li>Principios generales (art. 3 LRJSP)</li>
      <li>Jurisprudencia (complementa, no vincula salvo TC)</li>
      <li>Derecho UE (primacía y efecto directo)</li>
    </ul></li>
</ul>
</div>
...
*Fin del Tema 12 — Administrativo C1 | Preparación OEP 2026*
