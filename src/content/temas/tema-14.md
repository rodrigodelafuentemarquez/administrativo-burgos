...
## 1. LA LEY 40/2015, DE RÉGIMEN JURÍDICO DEL SECTOR PÚBLICO
...
- La **organización** de las Administraciones Públicas y sus órganos.
- Las **relaciones interadministrativas** (entre distintas Administraciones).
- El **sector público institucional** (organismos autónomos, entidades públicas empresariales, sociedades mercantiles públicas, fundaciones…).
- La **potestad reglamentaria** y los principios de buena regulación.
- La **responsabilidad patrimonial** del Estado legislador.

**Estructura de la LRJSP:**

| Título | Contenido |
|---|---|
| Título Preliminar | Disposiciones generales, principios, ámbito de aplicación |
| Título I | De las Administraciones Públicas y sus relaciones |
| Título II | De los órganos de las Administraciones Públicas |
| Título III | De los principios de la potestad reglamentaria |
| Título IV | Del sector público institucional estatal |
| Título V | De la responsabilidad patrimonial de las Administraciones Públicas |
| Título VI | De la responsabilidad patrimonial del Estado legislador |
| Título VII | Del funcionamiento electrónico del sector público |

### 1.2 Ámbito de aplicación (art. 2 LRJSP)

La LRJSP se aplica a:
- La **Administración General del Estado (AGE)**.
- Las **Administraciones de las Comunidades Autónomas**.
- Las **Entidades que integran la Administración Local**.
- El **sector público institucional** de cualquiera de las anteriores.

Las **Cortes Generales, las Asambleas legislativas autonómicas y los órganos constitucionales** se rigen por sus propias normas y solo supletoriamente por esta ley.
...
Los órganos administrativos se crean, modifican y suprimen mediante:
- **Ley**, cuando así lo exige la CE o cuando tienen competencias sobre los ciudadanos con efectos externos.
- **Real Decreto del Consejo de Ministros** o **Decreto del Consejo de Gobierno autonómico**, para los órganos de nivel superior o directivo.
- **Orden Ministerial**, para órganos de nivel inferior.

**Requisitos para la creación de un órgano (art. 5.4 LRJSP):**
...
> ⚠️ Está prohibido crear nuevos órganos que supongan duplicación de los ya existentes sin que se supriman o restrinjan los anteriores (principio de no duplicidad, art. 5.4 LRJSP).
...
Los **órganos colegiados** tienen reglas específicas de funcionamiento que garantizan el debate y la adopción válida de acuerdos:

#### Composición y presidencia:
- Tienen un **Presidente**, **Vicepresidente/s** (si los hubiere), **Vocales** y un **Secretario** (que puede o no ser miembro con voto).
- La presidencia dirige el órgano, ordena los debates y ostenta su representación.
- El secretario custodia la documentación, levanta actas y expide certificaciones.
...
#### Actas:
- De cada sesión se levanta **acta**, que debe contener los asistentes, el orden del día, las circunstancias de lugar y tiempo, los puntos principales de deliberación y el contenido de los acuerdos adoptados.
- El acta se aprueba en la misma sesión o en la siguiente.
- Los miembros pueden solicitar que conste en acta su voto contrario o las razones que lo justifican.

### 2.5 La abstención y la recusación (arts. 23 y 24 LRJSP)

Son técnicas para garantizar la **imparcialidad** en la actuación de las autoridades y empleados públicos.

**Causas de abstención (art. 23.2 LRJSP):**
- Tener **interés personal** en el asunto.
- Ser **administrador** de sociedad o entidad interesada.
- Tener **parentesco** (hasta cuarto grado de consanguinidad o segundo de afinidad) con los interesados o sus representantes o asesores.
- Haber tenido **intervención previa** en el asunto (perito, testigo, instructor…).
...
Los órganos superiores pueden dirigir la actuación de los inferiores mediante **instrucciones y circulares**. Son normas de carácter interno:
- No crean derechos ni obligaciones para los ciudadanos.
- Su incumplimiento puede dar lugar a responsabilidad disciplinaria del funcionario.
- Deben publicarse en el boletín oficial correspondiente si afectan a los ciudadanos o se refieren a actuaciones externas.
...
Las **relaciones interadministrativas** son las que se producen entre distintas Administraciones Públicas (Estado, CC.AA. y Entidades Locales) en el ejercicio de sus respectivas competencias.

El **art. 140 LRJSP** establece los principios que rigen estas relaciones:
...
### 3.2 Técnicas de colaboración y cooperación (arts. 141-162 LRJSP)

#### 3.2.1 El deber de información recíproca (art. 141 LRJSP)
Las Administraciones deben facilitarse mutuamente la información que precisen sobre su actividad y, en especial, la que tengan sobre normativas en preparación que puedan afectar al ámbito de las demás.

#### 3.2.2 Las Conferencias Sectoriales (arts. 147-151 LRJSP)
...
#### 3.2.4 Los convenios de colaboración (arts. 47-53 LRJSP)
...
#### 3.2.5 Los Planes y Programas conjuntos (art. 144 LRJSP)
Documentos de planificación que las Administraciones aprueban conjuntamente para la consecución de objetivos comunes en un sector determinado.

### 3.3 Técnicas de coordinación
...
<ul>
  <li>LRJSP (Ley 40/2015)
    <ul>
      <li>Regula: principios, organización, relaciones interadministrativas,
        <ul>
          <li>sector público institucional, responsabilidad patrimonial</li>
        </ul></li>
      <li>Ámbito: AGE + CC.AA. + EELL + sector público institucional</li>
    </ul></li>
  <li>ÓRGANOS ADMINISTRATIVOS
    <ul>
      <li>Concepto: unidad funcional con competencias propias</li>
      <li>Creación: por ley / Real Decreto / Orden Ministerial según rango</li>
      <li>Tipos: unipersonales / colegiados
        <ul>
          <li>superiores / directivos / de gestión (en AGE)</li>
        </ul></li>
      <li>ÓRGANOS COLEGIADOS (arts. 15-22 LRJSP)
        <ul>
          <li>Composición: Presidente + Secretario + Vocales</li>
          <li>Convocatoria: con antelación suficiente (mín. 48h)</li>
          <li>Quórum: mitad de miembros + Presidente + Secretario</li>
          <li>Acuerdos: mayoría de presentes (voto de calidad del Presidente)</li>
          <li>Actas: deben recoger asistentes, orden del día y acuerdos</li>
        </ul></li>
      <li>ABSTENCIÓN Y RECUSACIÓN (arts. 23-24 LRJSP)
        <ul>
          <li>Causas: interés personal, parentesco, intervención previa,
            <ul>
              <li>amistad íntima, enemistad, relación de servicio…</li>
            </ul></li>
          <li>Abstención: obligatoria, la acuerda el propio interesado</li>
          <li>Recusación: la pide el ciudadano, la resuelve el superior</li>
        </ul></li>
      <li>INSTRUCCIONES Y CIRCULARES (art. 6 LRJSP)
        <ul>
          <li>Internas, no crean derechos para ciudadanos</li>
        </ul></li>
    </ul></li>
  <li>RELACIONES INTERADMINISTRATIVAS
    <ul>
      <li>Principios: lealtad institucional, colaboración, cooperación,
        <ul>
          <li>coordinación</li>
        </ul></li>
      <li>Técnicas voluntarias (cooperación):
        <ul>
          <li>Deber de información recíproca (art. 141)</li>
          <li>Conferencias Sectoriales (multilateral, Estado-CCAA)</li>
          <li>Comisiones Bilaterales (bilateral, Estado-CC.AA.)</li>
          <li>Convenios (escritos, BOE, máx. 4 años prorrogables)</li>
          <li>Planes y programas conjuntos</li>
        </ul></li>
      <li>Técnicas vinculantes (coordinación): por ley o por el Estado</li>
      <li>Conflictos:
        <ul>
          <li>Competenciales → Tribunal Constitucional</li>
          <li>Control excepcional: art. 155 CE (CC.AA.) / art. 60 LBRL (EELL)</li>
        </ul></li>
    </ul></li>
</ul>
</div>
...
*Fin del Tema 14 — Administrativo C1 | Preparación OEP 2026*
