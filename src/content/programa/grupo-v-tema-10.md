...
| Teams | Reuniones, chats y colaboración interna. |
...
Reglas prácticas de uso administrativo:

1. El documento de trabajo no sustituye al documento administrativo definitivo.
2. Los permisos deben ajustarse a la necesidad real.
3. Los datos personales deben limitarse a lo imprescindible.
4. Las versiones finales deben incorporarse al expediente por el canal oficial.
5. Antes de enviar, hay que revisar comentarios, control de cambios y metadatos.
...
- **encabezado** con órgano, unidad o expediente;
- **asunto** claro;
- **antecedentes** o contexto cuando proceda;
- **fundamentos** o base jurídica si el documento lo requiere;
- **contenido decisorio o informativo**;
- **fecha, firma y validación**;
- incorporación al expediente electrónico cuando corresponda.
...
| Comentarios | Facilitan revisión interna antes de aprobar documento. |
...
La colaboración en Microsoft 365 debe controlar permisos. No es lo mismo permitir lectura que edición. Tampoco es igual compartir con una persona concreta que generar un enlace abierto. En documentos con datos personales, la regla debe ser minimización: solo accede quien necesita acceder.

Antes de compartir un documento conviene comprobar:

- destinatarios y permisos;
- si contiene datos personales o información reservada;
