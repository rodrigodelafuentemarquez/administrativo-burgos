...
| --- | --- |
| Administrativo | Pantallas, postura, carga mental, atención al público, caidas al mismo nivel. |
...
| --- | --- |
| Evitar riesgos | Eliminar una tarea peligrosa si puede organizarse de otro modo. |
| Evaluar riesgos inevitables | Analizar pantalla, postura, carga mental o atención conflictiva. |
| Combatir en origen | Mejorar iluminación o mobiliario, no solo recomendar pausas. |
| Adaptar trabajo a la persona | Ajustar puesto, silla, pantalla, turnos o herramientas. |
| Planificar prevención | Integrar medidas, responsables, plazos y seguimiento. |
| Protección colectiva | Preferir medidas organizativas frente a soluciones individuales aisladas. |
| Dar instrucciones | Formación clara sobre equipos, emergencias y protocolos. |
...
- integrar la prevención en la organización;
...
| --- | --- | --- |
| Ergonomico | Dolor cervical por pantalla baja. | Regular pantalla a altura adecuada. |
| Visual | Fatiga por brillo o reflejos. | Iluminación correcta y pausas visuales. |
| Postural | Sedestación prolongada. | Silla ajustable y cambios de postura. |
| Psicosocial | Atención a público conflictivo. | Protocolos, formación y apoyo. |
| Organizativo | Sobrecarga en plazos. | Planificación y distribución de tareas. |
| Caidas | Cables o cajas en paso. | Orden, canaletas y zonas despejadas. |
| Electrico | Regletas sobrecargadas. | Equipos revisados y uso adecuado. |

## Medidas preventivas

Debe ajustarse puesto de pantalla, silla, mesa e iluminación; realizar pausas; alternar tareas; mantener orden y cableado seguro; formar en atención al público conflictiva; aplicar protocolos frente a acoso y violencia; respetar evacuación y emergencias; usar equipos correctamente; y comunicar incidencias.

La prevención en oficinas no es menor: reduce bajas, errores, conflictos y deterioro de salud.

| Medida | Cómo se aplica en oficina |
| --- | --- |
...
| Orden | Evitar cajas, cables y obstáculos en zonas de paso. |
