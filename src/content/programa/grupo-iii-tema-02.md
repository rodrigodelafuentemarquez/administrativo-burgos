...
La materia se regula en el EBEP, normativa estatal y autonómica de función pública, legislación local y normas específicas de funcionarios de Administración Local.
...
| Toma de posesión | Inicio efectivo de la relación funcionarial. |
...
| --- | --- |
| Servicio activo | Presta servicios y conserva plenitud ordinaria de derechos/deberes. |
| Servicios especiales | Desempena cargos o funciones públicas relevantes con reserva y computos. |
| Servicio en otras Administraciones | Obtiene destino en otra Administración mediante movilidad. |
...
Esta situación aparece cuando un funcionario obtiene destino en otra Administración mediante procedimientos de movilidad. Mantiene su condición de funcionario de origen, pero se integra funcionalmente en la Administración de destino. Sus efectos dependen de la normativa de movilidad.
...
La excedencia por violencia de género o terrorista tiene protección reforzada, con reserva de puesto y derechos específicos para garantizar seguridad y asistencia.

| Modalidad | Finalidad |
| --- | --- |
| Interes particular | Apartamiento voluntario por decisión personal, con requisitos y sin retribuciones. |
| Agrupación familiar | Facilitar convivencia cuando el conyuge reside en otra localidad por puesto definitivo. |
| Cuidado de hijos o familiares | Proteger conciliación y cuidados. |
| Violencia de género | Garantizar protección, asistencia y movilidad de la victima. |
| Violencia terrorista | Proteger a victimas y facilitar seguridad o asistencia. |
...
| --- | --- |
| Reserva de puesto | Determina si la plaza puede cubrirse definitivamente o solo temporalmente. |
| Computo de antiguedad | Afecta a trienios, carrera y concursos. |
| Retribuciones | Algunas situaciones no generan sueldo del puesto de origen. |
| Seguridad Social o derechos pasivos | Deben comunicarse y gestionarse correctamente. |
| Reingreso | Puede exigir solicitud, vacante y procedimiento. |

Para estudiar este tema conviene separar tres planos: adquirir la condición, perder la condición y cambiar de situación sin perderla. Muchas preguntas trampa mezclan estos planos.
