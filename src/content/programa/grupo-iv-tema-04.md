...
El control del gasto público garantiza **legalidad, eficiencia, estabilidad, transparencia y responsabilidad** en el uso de fondos. No se limita a comprobar facturas: controla que el gasto sea competente, necesario, presupuestado, tramitado y justificado.

<mark>Clave de examen:</mark> controlar el gasto no es "poner trabas"; es asegurar que el dinero público se gasta con competencia, crédito, procedimiento, justificación y finalidad pública.

| Pregunta de control | Qué se comprueba |
| --- | --- |
...
- omisión de requisitos o trámites esenciales;
- gastos sin fiscalización previa obligatoria;
...
1. Formación por la Intervención.
2. Informe de la Comisión Especial de Cuentas.
...
| Institución | Papel |
| --- | --- |
| Tribunal de Cuentas | Supremo órgano fiscalizador y enjuiciador de responsabilidad contable. |
| Consejo de Cuentas de Castilla y León | Fiscaliza sector público autonómico y entidades locales de la Comunidad. |
| Cortes de Castilla y León | Reciben informes y ejercen control político en el ámbito autonómico. |

La responsabilidad contable puede surgir cuando se produce menoscabo de fondos públicos por dolo, culpa o negligencia grave en quienes manejan caudales o efectos públicos. No todo error administrativo genera responsabilidad contable, pero si debe existir trazabilidad documental para explicar decisiones, pagos, ingresos y controles.

Para un administrativo municipal, el control se traduce en expedientes completos, documentos fechados, informes incorporados, firmas correctas, crédito comprobado, facturas conformadas, registros de entrada y salida, y archivo ordenado. El control empieza mucho antes del informe final: empieza en cada trámite bien hecho.
