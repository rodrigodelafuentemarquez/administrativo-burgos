...
| Contratación | Licitaciones, adjudicaciones, modificaciones, contratos menores, datos estadisticos. |
...
| --- | --- |
| Seguridad pública | Datos operativos sensibles de dispositivos policiales. |
| Investigación de infracciones | Actuaciones inspectoras en curso si el acceso las perjudica. |
| Intereses económicos y comerciales | Secretos empresariales incluidos en una oferta. |
| Protección de datos | Datos personales no necesarios para la finalidad de transparencia. |
