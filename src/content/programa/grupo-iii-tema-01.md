...
tema: 1
codigo: "Tema III.1"
titulo: "El personal al servicio de las entidades locales: clases y régimen jurídico. Provisión de puestos de trabajo en la función pública. Los deberes y derechos de los funcionarios. La carrera administrativa. Promoción interna."
estado: "borrador"
---
...
Las entidades locales cuentan con **empleados públicos** para ejercer competencias y prestar servicios. La organización del personal se refleja en <mark>plantilla presupuestaria, relación de puestos de trabajo, oferta de empleo público, bases de selección y acuerdos reguladores</mark>.

El personal local se integra en una Administración territorial, pero su régimen combina normativa estatal básica, normativa autonómica, normativa local y, cuando procede, legislación laboral.

Para estudiar este tema conviene separar tres planos:

1. **Clases de personal:** quien trabaja para la entidad local y con que vinculo.
2. **Ordenación de puestos:** plantilla, RPT, oferta y provisión.
3. **Derechos, deberes y carrera:** que estatuto jurídico tiene el empleado público una vez incorporado.
...
| --- | --- | --- | --- |
| Funcionario de carrera | Nombramiento legal | Relación permanente y ejercicio de funciones públicas. | Inamovilidad en la condición funcionarial. |
| Funcionario interino | Nombramiento temporal | Necesidad y urgencia en supuestos tasados. | No es funcionario de carrera, aunque ocupe funciones funcionariales. |
| Personal laboral | Contrato de trabajo | Fijo, indefinido o temporal. | Derecho laboral + EBEP en materias comunes. |
| Personal eventual | Nombramiento libre | Confianza o asesoramiento especial. | Cesa al cesar la autoridad que lo nombro. |
...
- **Acceso:** permite adquirir la condición de funcionario de carrera o personal laboral fijo.
...
La provisión de puestos es la forma de ocupar puestos concretos por personal que ya tiene condición de empleado público. Debe distinguirse del acceso, que permite adquirir la condición de funcionario o laboral fijo.

Los procedimientos ordinarios de provisión de puestos de funcionarios son concurso y libre designación con convocatoria pública. El concurso valora meritos, capacidades y aptitudes conforme a bases. La libre designación se reserva a puestos de especial responsabilidad y exige convocatoria pública, apreciación discrecional motivada y cese conforme a la normativa.
...
| Comisión de servicios | Temporal y provisional. | Cubrir un puesto urgente mientras se convoca provisión definitiva. |
| Adscripción provisional | Ocupación temporal tras cese, remoción o supuestos previstos. | Reubicación hasta obtener destino definitivo. |
...
| Negociación colectiva | Participación en condiciones de trabajo dentro del marco legal. |
...
| --- | --- |
| Carrera horizontal | Progresar sin cambiar necesariamente de puesto. |
| Carrera vertical | Ascender en la estructura de puestos. |
| Promoción interna vertical | Pasar a cuerpo/escala de grupo o subgrupo superior. |
| Promoción interna horizontal | Acceder a otro cuerpo o escala del mismo subgrupo. |

<mark>Clave final del tema:</mark> la función pública local se entiende mejor si se distingue **persona**, **plaza**, **puesto** y **procedimiento**. La persona accede a la condición; la plaza aparece en plantilla y oferta; el puesto se describe en la RPT; y el procedimiento determina acceso, provisión, carrera o promoción.
