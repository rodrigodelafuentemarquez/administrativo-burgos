...
tema: 3
codigo: "Tema II.3"
titulo: "El procedimiento administrativo común: concepto, naturaleza y principios generales. Fases del procedimiento: iniciación, ordenación, instrucción y finalización. Ejecución."
estado: "borrador"
---
...
El procedimiento administrativo común es el conjunto ordenado de actos y trámites que debe seguir la Administración para dictar una resolución administrativa. No es una formalidad secundaria: es la garantía de que la decisión administrativa se adopta con competencia, audiencia, prueba, informes, motivación y control.
...
|---|---|
| Naturaleza | Sucesión ordenada de actos para dictar una resolución. |
| Perspectiva garantista | Protege derechos del interesado. |
| Perspectiva organizativa | Ordena la actuación administrativa y la legalidad del expediente. |
| Norma básica | `Ley 39/2015`. |

## Principios generales

El procedimiento se rige por legalidad, eficacia, celeridad, economía, transparencia, contradicción, igualdad, buena fe, confianza legitima, proporcionalidad, simplificación administrativa y administración electrónica.
...
|---|---|
| Legalidad | El procedimiento debe ajustarse a la ley. |
| Eficacia y celeridad | Impulso rapido y ordenado del expediente. |
...
1. Conocer el estado del procedimiento.
2. Acceder al expediente.
3. Formular alegaciones y aportar documentos.
4. Identificar autoridades y personal responsables.
5. Obtener copias y no repetir documentos ya aportados.
...
| A solicitud del interesado | Mediante instancia con contenido mínimo legal. |
| Subsanación | `Diez días` para corregir defectos, salvo ampliación legalmente posible. |
| Medidas provisionales | Posibles si son necesarias y proporcionadas. |
...
| Celeridad | Acumulación de trámites compatibles y respeto a plazos. |
| Expediente | Debe estar ordenado y ser trazable. |
| Medio ordinario | Tramitación electrónica. |

## Instrucción

La instrucción comprende los actos necesarios para determinar, conocer y comprobar los hechos sobre los que debe resolverse. Incluye alegaciones, prueba, informes, participación de interesados, audiencia e información pública cuando proceda.
...
- Los informes, salvo previsión expresa, son `facultativos` y `no vinculantes`.
- La audiencia suele situarse `antes` de redactar la propuesta de resolución.

## Finalización

El procedimiento puede finalizar por resolución, desistimiento, renuncia, caducidad, imposibilidad material sobrevenida, terminación convencional o acuerdo.

La resolución debe decidir todas las cuestiones planteadas por los interesados y las derivadas del procedimiento. Debe ser congruente con las peticiones, motivada cuando proceda, y contener recursos posibles.
...
|---|---|
| Resolución | Decisión expresa sobre el fondo. |
| Desistimiento | El interesado abandona la solicitud o el procedimiento. |
| Renuncia | Abandono del derecho, si es renunciable. |
| Caducidad | Extinción por inactividad o transcurso del plazo en ciertos casos. |
| Terminación convencional | Acuerdo compatible con la ley. |
| Imposibilidad material | No puede continuarse o resolverse normalmente por causa sobrevenida. |

## Ejecución

Los actos administrativos son ejecutivos salvo suspensión. La Administración puede ejecutar forzosamente sus actos previa advertencia cuando el interesado no cumpla voluntariamente. Los medios de ejecución forzosa son apremio sobre el patrimonio, ejecución subsidiaria, multa coercitiva y compulsión sobre las personas.
