...
| Tasa | Existe uso privativo del dominio público o prestación de servicio/actividad que beneficia especialmente. | Ocupación de vía pública, expedición de documentos, recogida de residuos si se configura como tasa. |
...
La diferencia entre impuesto y tasa es esencial en examen. En el impuesto no hay una prestación municipal concreta a favor del contribuyente; en la tasa si hay una relación más directa con el dominio público o con un servicio. Por eso una ordenanza de tasa necesita especial cuidado en la memoria económica: si el coste del servicio no está justificado, la tasa puede ser discutida.
...
| IVTM | Obligatorio, directo. | Grava la titularidad de vehículos aptos para circular. |
...
Una ordenanza fiscal no debe estudiarse solo como un texto normativo. Es una herramienta de gestión: permite saber quién debe pagar, cuándo nace la obligación, cómo se calcula la cuota, qué beneficios fiscales existen, qué documentación se exige y qué órgano resuelve. Si la ordenanza es imprecisa, después aparecen problemas en liquidaciones, recursos, padrones y atención al contribuyente.
...
| Gestión | Cómo se declara, liquida, notifica, recauda o revisa. |
...
| Error material, duplicidad o ingreso indebido | Procedimientos de rectificación, devolución de ingresos indebidos o revisión según proceda. |

Para un puesto administrativo, lo importante no es solo saber la vía teórica, sino clasificar bien el escrito que presenta la persona contribuyente. No es lo mismo decir "esta tasa es ilegal" que decir "me han cobrado dos veces", "ya vendí el vehículo", "tengo derecho a bonificación" o "la notificación no me llegó correctamente". Cada caso abre un tratamiento distinto.
