...
La materia urbanística combina normativa estatal de suelo, legislación urbanística de Castilla y León, reglamentos urbanísticos, planeamiento municipal y ordenanzas. En Burgos debe atenderse al planeamiento urbanístico vigente y a la normativa autonómica aplicable.
...
| --- | --- | --- |
| Clasificación | Qué clase jurídica de suelo es. | Urbano, urbanizable, rústico/no urbanizable. |
| Calificación | Qué uso y condiciones concretas tiene. | Residencial, industrial, equipamiento, zonas verdes, altura máxima. |
| Ordenación | Cómo se estructura la actuación urbanística. | Alineaciones, parcelas, viales, dotaciones, aprovechamientos. |
| Gestión | Cómo se ejecuta el planeamiento. | Reparcelación, urbanización, cesiones, distribución de cargas. |
...
| --- | --- |
| Obra mayor o nueva edificación | Licencia urbanística, con informes técnicos y jurídicos. |
| Obra menor | Licencia, declaración responsable o comunicación según ordenanza. |
...
| Respuesta | Finalidad |
| --- | --- |
| Legalización | Comprobar si lo ejecutado puede ajustarse al planeamiento y obtener título habilitante. |
...
Ejemplo: si se ejecuta una obra sin licencia pero compatible con el planeamiento, puede exigirse legalización y tramitarse sanción si procede. Si la obra es incompatible, la Administración debe ordenar restauración, como demolición o reposición, además de valorar la sanción.
