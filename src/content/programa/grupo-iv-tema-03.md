...
| Fase | Nombre | Efecto |
| --- | --- | --- |
| RC | Retención de crédito | Reserva crédito antes de aprobar el gasto. |
...
La documentación soporte incluye propuesta, informe, retención de crédito, pliegos, adjudicación, contrato, factura, certificación, conformidad del servicio, fiscalización, resolución y orden de pago.

| Tipo de expediente | Documentación habitual |
| --- | --- |
| Contrato menor | Memoria o propuesta, crédito, aprobación, factura, conformidad y reconocimiento de obligación. |
| Contrato ordinario | Pliegos, informes, fiscalización, licitación, adjudicación, formalización, certificaciones/facturas. |
| Subvención | Convocatoria o concesión, crédito, resolución, justificación, comprobación y pago. |
