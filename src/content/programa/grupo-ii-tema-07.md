...
tema: 7
codigo: "Tema II.7"
titulo: "Los contratos del sector público: tipología contractual. Las partes en el contrato. El expediente de contratación. Procedimientos de adjudicación. Efectos, cumplimiento y extinción de los contratos de las administraciones públicas. La revisión de precios y otras alteraciones contractuales. Régimen de invalidez y recursos."
estado: "borrador"
---
...
| Concurrencia | Debe facilitarse participación de empresas aptas. |
| Igualdad y no discriminación | Los licitadores compiten con las mismas reglas. |
| Transparencia | Criterios, valoraciones y decisiones deben ser claros y motivados. |
| Integridad | Prevención de conflictos de intereses y corrupción. |
| Eficiencia | Compra adecuada a necesidades reales y buen uso de fondos. |

La contratación pública empieza antes de publicar un anuncio. Primero hay que definir necesidad, objeto, presupuesto, financiación, división en lotes, solvencia, criterios de adjudicación y condiciones de ejecución.
...
| --- | --- |
| Obras | Ejecución de una obra o trabajos de construcción/ingenieria. |
| Concesión de obras | Obra con explotación por el concesionario y riesgo operacional. |
...
| Mixto | Combina prestaciones; se atiende a la prestación principal y reglas legales. |
...
| --- | --- |
| Memoria justificativa | Explica necesidad, objeto, insuficiencia de medios y elección del procedimiento. |
| Credito y fiscalización | Aseguran financiación y control presupuestario. |
| Pliego administrativo | Regula procedimiento, criterios, garantías, penalidades y ejecución. |
| Pliego técnico | Define carácterísticas técnicas de la prestación. |
| Anuncio y licitación | Permiten publicidad y concurrencia. |
| Valoración | Aplica criterios automaticos y sujetos a juicio de valor. |
| Adjudicación y formalización | Seleccionan contratista y perfeccionan el contrato. |

## Procedimientos de adjudicación

El procedimiento abierto permite que cualquier empresario interesado presente proposición. Es el procedimiento ordinario más transparente. El abierto simplificado agiliza contratos que cumplen requisitos legales. El restringido exige selección previa de candidatos.

El procedimiento negociado solo procede en supuestos tasados. El dialogo competitivo y la asociación para la innovación se reservan a necesidades complejas. El contrato menor tiene tramitación simplificada, límites cuantitativos y exigencias antifraccionamiento.
...
La revisión de precios solo procede en supuestos y condiciones legalmente previstos. Busca corregir variaciones económicas en contratos de duración o naturaleza que lo justifiquen, evitando alteraciones arbitrarias.

La modificación contractual está fuertemente limitada. Puede estar prevista en pliegos de forma clara, precisa e inequívoca, o acordarse por causas no previstas cuando concurran circunstancias legalmente tasadas. No puede alterar la naturaleza global del contrato ni utilizarse para eludir una nueva licitación.
...
Durante la ejecución se controlan plazos, calidad, facturas, penalidades, recepción, garantías y pago. Las modificaciones solo proceden en supuestos previstos o legalmente habilitados; no pueden utilizarse para alterar de forma fraudulenta la licitación.

| Incidencia | Idea clave |
| --- | --- |
| Prorroga | Debe estar prevista y acordarse conforme al pliego y la ley. |
| Modificación | Requiere causa, procedimiento y límites. |
| Revisión de precios | Solo en supuestos legalmente admitidos. |
| Penalidades | Reacción frente a incumplimientos sin resolver necesariamente el contrato. |
| Resolución | Extingue por incumplimiento, imposibilidad u otras causas. |

En el ámbito municipal, contratar bien significa preparar bien. Muchos problemas de ejecución nacen de pliegos imprecisos, criterios mal definidos, presupuesto insuficiente o falta de seguimiento por el responsable del contrato.
